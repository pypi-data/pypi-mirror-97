...
class accuinsight(object):
    ...
    def set_storage(self,
        ...
        if save_json == True:
            save_prefix = os.path.join(ENV_JUPYTER_HOME_DIR, 'runs', 'storage-info-json')
        ...
        if hdfs_uri is not None:
            ...
            split_2 = [i.split(':') for i in split1 if ':' in i][0]
