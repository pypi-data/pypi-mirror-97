...
def gtdb_16s(args):
    ...
    op_classified       = '%s_classified'           % output_prefix
    op_unclassified     = '%s_unclassified'         % output_prefix

    # get_query_seq_list
    print('Get the id of query sequences')
    query_seq_set = set()
    ...
    print('Get taxonomy of query sequences')
    ...
    print('Classification results exported to %s' % op_classified)
    print('ID of unclassified sequences exported to %s' % op_unclassified)
    print('Done!')
