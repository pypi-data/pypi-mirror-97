...
def ralston2(func, return_im=False):
    ...
    if not return_im:
        def int_func(x, t, *args):
            k1 = func(x, t, *args)
            k2 = func(x + dt * k1 * 2 / 3, t + dt * 2 / 3, *args)
            y = x + dt * (k1 / 4 + k2 * 3 / 4)
            return y
...
def rk2(func, beta=2 / 3):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + beta * dt * k1, t + beta * dt, *args)
...
def rk3(func, *args):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + dt / 2 * k1, t + dt / 2, *args)
        k3 = func(x - dt * k1 + 2 * dt * k2, t + dt, *args)
...
def heun3(func, return_im=False):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + dt / 3 * k1, t + dt / 3, *args)
        k3 = func(x + 2 / 3 * dt * k2, t + dt * 2 / 3, *args)
...
def ralston3(func, return_im=False):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + dt / 2 * k1, t + dt / 2, *args)
        k3 = func(x + 3 / 4 * dt * k2, t + dt * 3 / 4, *args)
...
def ssprk3(func, return_im=False):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + dt * k1, t + dt, *args)
        k3 = func(x + dt * k1 / 4 + dt * k2 / 4, t + dt / 2, *args)
...
def rk4(func, *args):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + dt / 2 * k1, t + dt / 2, *args)
        k3 = func(x + dt / 2 * k2, t + dt / 2, *args)
        k4 = func(x + dt * k3, t + dt, *args)
...
def ralston4(func, return_im=False):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + dt * k1 * 0.4, t + dt * 0.4, *args)
        k3 = func(x + dt * k1 * .29697761 + dt * k2 * .15875964, t + dt * .45573725, *args)
        k4 = func(x + dt * k1 * .21810040 + dt * k2 * -3.05096516 + dt * k3 * 3.83286476, t + dt, *args)
...
def rk4_38rule(func, *args):
    ...
    def int_func(x, t, *args):
        k1 = func(x, t, *args)
        k2 = func(x + dt / 3 * k1, t + dt / 3, *args)
        k3 = func(x - dt / 3 * k1 + dt * k2, t + 2 * dt / 3, *args)
        k4 = func(x + dt * k1 - dt * k2 + dt * k3, t + dt, *args)
