...
__date__      = '2021-March-7'   
__url__       = 'https://engineering.purdue.edu/kak/distDLS/DLStudio-2.0.5.html'
...
CHANGE LOG:
  ...
  Version 2.0.5:
    ...
    intermediate results produced during a training loop are displayed in
    your terminal window.  In addition, I deleted the part of DLStudio that
...
#        summary(net, (3,self.image_size[0],self.image_size[1]),-1, device='cpu')
        summary(net, (3,self.image_size[0],self.image_size[1]))
...
#                tempmask = self.dataset[idx][3]
#                tempmask_np = np.array(tempmask)
#                mask_shape = tempmask.shape
#                print("\n\nshape of the mask: %s\n\n" % str(mask_shape))
#                sys.exit("\n\nexiting in get_item of dataloader\n\n")
