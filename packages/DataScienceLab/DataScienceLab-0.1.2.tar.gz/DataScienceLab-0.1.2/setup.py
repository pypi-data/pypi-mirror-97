...
setup(
  ...
  download_url = 'https://github.com/mbroend/DataScienceLab/archive/v_01.2.tar.gz',    # I explain this later on
  keywords = ['SQL', 'SERVER', 'CONNECTION', 'SIMPLIFIED'],   # Keywords that define your package best
