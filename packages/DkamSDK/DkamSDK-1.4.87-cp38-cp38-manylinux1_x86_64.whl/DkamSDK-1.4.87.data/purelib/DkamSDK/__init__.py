...
def ROIMappingCoordinateCSharp(camera_index, roi_output_size, roi_output, target_data, target_pixel_size, point_output):
    """
    The Function is: According to the set RGB or RGB area of interest, corresponding to a specific region in the infrared or RGB image. in csharp version.
    """
    return _DkamSDK.ROIMappingCoordinateCSharp(camera_index, roi_output_size, roi_output, target_data, target_pixel_size, point_output)

def ROIPixelMappingCSharp(camera_index, point_data, point_pixel, point_pixel_size, source_data, source_data_pixel, source_pixel_size, target_data, target_data_pixel, target_pixel_size, roi_input, ROI_output_size, ROI_output):
    """
    The Function is: Retrieve ROI regions from point cloud, infrared, and RGB in csharp version.
    """
    return _DkamSDK.ROIPixelMappingCSharp(camera_index, point_data, point_pixel, point_pixel_size, source_data, source_data_pixel, source_pixel_size, target_data, target_data_pixel, target_pixel_size, roi_input, ROI_output_size, ROI_output)
