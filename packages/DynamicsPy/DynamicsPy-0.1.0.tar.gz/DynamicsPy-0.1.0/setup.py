...
with open(os.path.join(here, 'dynamics', '__init__.py'), 'r') as f:
    init_py = f.read()
...
setup(
    name='DynamicsPy',
    version=version,
    description='DynamicsPy: A backend-free numerical integration software for differential equations',
