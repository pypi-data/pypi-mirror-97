...
class UIWindow(tk.Tk):
    ...
    def __init__(self, radio_dir=None, settings_path=None):
        ...
        self.canvas = tk.Canvas(self.center, bg='cornflowerblue', width=570, height=360, bd=0)
    ...
    def browse_file_button(self):
        ...
        # get the radios
        self.load_settings(term.GIni.list_items, self.canvas_frame)  # only keys, not values
