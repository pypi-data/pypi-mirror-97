...
async def create_all_type_evaluators(tentacles_setup_config: object,
    ...
    return await evaluator.create_all_type_evaluators(tentacles_setup_config=tentacles_setup_config,
                                                      matrix_id=matrix_id,
...
async def create_evaluators(evaluator_parent_class,
    ...
    return await evaluator.create_evaluators(
...
async def create_evaluator(evaluator_class,
    ...
    return await evaluator.create_evaluator(evaluator_class=evaluator_class,
                                            tentacles_setup_config=tentacles_setup_config,
                                            matrix_id=matrix_id,
                                            exchange_name=exchange_name,
                                            bot_id=bot_id,
                                            ...
                                            relevant_evaluators=relevant_evaluators,
                                            all_symbols_by_crypto_currencies=all_symbols_by_crypto_currencies,
                                            time_frames=time_frames,
                                            real_time_time_frames=real_time_time_frames)
