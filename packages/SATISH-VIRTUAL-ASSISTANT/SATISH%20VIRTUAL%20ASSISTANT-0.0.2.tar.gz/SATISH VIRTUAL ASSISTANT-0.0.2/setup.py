...
setup(
  name='SATISH VIRTUAL ASSISTANT',
  version='0.0.2',
  description="This is a very basic python based voice virtual assistant that performs multiple tasks based on voice commands",
