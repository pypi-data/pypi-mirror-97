...
class AgentConnectorConnectionInfo(object):
    ...
    def __init__(self, connection_uri=None, connection_location=None, connection_path=None, connection_org_id=None, connection_app_name=None, end_to_end_tls=None, max_number_connections=16, ip_services=None, file_share_services=None, local_vars_configuration=None):  # noqa: E501
