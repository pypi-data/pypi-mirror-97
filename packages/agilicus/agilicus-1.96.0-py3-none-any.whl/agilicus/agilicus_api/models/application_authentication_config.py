...
"""
    ...
    The version of the OpenAPI document: 2021.03.08
...
class ApplicationAuthenticationConfig(object):
    ...
    def session_secret(self, session_secret):
        ...
        if (self.local_vars_configuration.client_side_validation and
                session_secret is not None and len(session_secret) > 64):
            raise ValueError("Invalid value for `session_secret`, length must be less than or equal to `64`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
