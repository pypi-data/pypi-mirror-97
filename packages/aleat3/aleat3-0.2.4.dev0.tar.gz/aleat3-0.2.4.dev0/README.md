...
#### What's new in aleat3 0.2.4 (on development)
...
- `--add / --a`
  - Add an Aleatoryous type and retrieve a result.
  - __Arguments__: A formal name of any aleat3 syntax (which start with prefix "aleatory")
- `--coinconvert / --c / --coin`
  - Make a `coinToBool()` or a `coinToBinary()` conversion.
  - __Arguments__: "bool" or "binary"
- `--version / --v`
  - Get the version of aleat3.
  - __Arguments__: None.
