...
from alectio_helpers.interface.artifacts import ArtifactManifest
import alectio_helpers.filesync.step_prepare
...
class ArtifactSaver(object):
    ...
    def save(
        ...
        step_prepare = alectio_helpers.filesync.step_prepare.StepPrepare(
        ...
        def before_commit():
            ...
            digest = alectio_helpers.util.md5_file(path)
