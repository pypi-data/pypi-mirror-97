...
class Client(object):
    ...
    def meter(self, meter_name, meter_value, utc_time_millis, customer_id=None, customer_name=None, dimensions=None, unique_id=None):
        '''creates the message and enqueues it'''

        message = MeterFactory.create(meter_name=meter_name, meter_value=meter_value, utc_time_millis=utc_time_millis, 
        customer_id=customer_id, customer_name=customer_name, dimensions=dimensions, unique_id=unique_id)
