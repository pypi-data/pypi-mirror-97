    ...
    def _Run(self, name, gopts, argv):
        ...
        try:
            ...
            if not self.conf.init:
                ...
                put_string("      if the workspace is not intialized(no .aos file in the workspace root directory),")
                put_string("      please run 'aos init' in the workspace root directory.")
            return 1
