...
with DAG(
    ...
    fetch_tweets = PythonOperator(task_id='fetch_tweets', python_callable=fetchtweets,provide_context=True)
    ...
    clean_tweets = PythonOperator(task_id='clean_tweets', python_callable=cleantweets,provide_context=True)
    ...
    analyze_tweets = PythonOperator(task_id='analyze_tweets', python_callable=analyzetweets,provide_context=True)
    ...
    hive_to_mysql = PythonOperator(task_id='hive_to_mysql', python_callable=transfertodb,provide_context=True)
