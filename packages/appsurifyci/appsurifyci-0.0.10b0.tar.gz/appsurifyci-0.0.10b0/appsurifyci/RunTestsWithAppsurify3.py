...
def runtestswithappsurify(*args):
    ...
    if testtemplate == "azure dotnet":
        ...
        while len(testsrun) > max_length:
            ...
            print("testsrun = " + testsrun)
            print("setval = " + setval)
            print (f'##vso[task.setvariable variable=TestsToRun{variable_num}]{setval}')
            variable_num = variable_num + 1
        print (f'##vso[task.setvariable variable=TestsToRun{variable_num}]{testsrun}')
