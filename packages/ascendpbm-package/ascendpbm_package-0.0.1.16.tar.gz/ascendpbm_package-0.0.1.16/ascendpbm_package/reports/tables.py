...
def check_employee_sql(memberid, groupnum, group_personcodes):
    if optimed == True:
        return pd.Series(index=memberid.index, dtype=bool) = True
    else:
        import pandas as pd
...
# df_members and df_employees are required dataframes of all members and employees for a group, structured as in transforms.py (part of our reporting project)
