...
def ranking_table(dff, n, ranker="Plan Pay", grouper="Drugs", subgrouper=None,
...
def time_table(dff, n, start_date, end_date, rankfirst=False, ranker="Plan Pay", grouper = "Drugs", time = "Day",
