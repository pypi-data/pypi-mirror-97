...
def ranking_table(dff, n, available_indicators, available_indicators= ['AWP', 'Client Savings', 'Copay', 'Days Supply', 'Disp Fee',
...
def time_table(dff, n, start_date, end_date, available_indicators=['AWP', 'Client Savings', 'Copay', 'Days Supply', 'Disp Fee',
                                                                   'Drug Cost', 'Estimated Network Rate', 'Ingredient Cost',
                                                                   'Member Pay', 'Network Savings', 'Plan Pay', 'Quantity',
                                                                   'Sales Tax', 'Total Amount', 'U&C'],
               rankfirst=False, ranker="Plan Pay", grouper = "Drugs", time = "Day",
               applyform = False, form = '${:,.0f}', avgmonth = False):
    import pandas as pd
