...
class ComponentRepresentation(object):
    ...
    def __init__(self, id=None, name=None, label=None, asset_id=None, asset_category=None, asset_category_id=None, component_type=None, network_measure_type=None, dimension_unit=None, material_type=None, design_life=None, external_identifier=None, reference_value=None, reference_date=None, last_modified=None, financial_class_id=None, financial_class_name=None, financial_sub_class_id=None, financial_sub_class_name=None, links=None, embedded=None):  # noqa: E501
