...
*OperatorsApi* | [**list_operator_properties**](docs/OperatorsApi.md#list_operator_properties) | **GET** /supported-operators/{operator_type} | 
...
## Documentation For Models
 ...
 - [ClusterOperator](docs/ClusterOperator.md)
 ...
 - [SupportedOperatorsList](docs/SupportedOperatorsList.md)
