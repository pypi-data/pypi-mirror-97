...
JAR_PATH = (Path(__file__).parent / "data" / "atoti-legacy-app.jar").absolute()


class LegacyAppPlugin(Plugin):
    """Legacy ActiveUI 4 app plugin."""
    ...
    def init_session(self, session: Session):
        ...
        session._java_api.gateway.jvm.io.atoti.spring.plugins.LegacyAppPlugin.init()  # type: ignore
