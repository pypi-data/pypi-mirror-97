...
class JavaIterator(JavaObject):
    ...
    def next(self):
        ...
        try:
            ...
            # HACK : https://github.com/activeviam/atoti/issues/1895
            # FutureWarning to throw an error when running pytest. Java collection
            # must be converted using to_python_list/array...
            warnings.warn(str(e), category=FutureWarning, stacklevel=2)
            raise StopIteration()
