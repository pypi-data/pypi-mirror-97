...
from .compat import CompatThread, Queue, basestring, hasattr2, range
from .finalizer import ThreadSafeFinalizer
...
if PY4J_SKIP_COLLECTIONS not in os.environ or\
   os.environ[PY4J_SKIP_COLLECTIONS].lower() not in PY4J_TRUE:
    __import__("atoti._vendor.atotipy4j.java_collections")
