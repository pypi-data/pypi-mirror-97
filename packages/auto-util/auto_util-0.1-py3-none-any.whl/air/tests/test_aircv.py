...
import unittest
from air.aircv.keypoint_matching import *  # noqa
from air.aircv.keypoint_matching_contrib import *  # noqa
from air.aircv import *  # noqa
from air.aircv import *  # noqa
from air.aircv import *
from air.aircv import find_template, find_all_template
...
class TestAircv(unittest.TestCase):
    ...
    def test_func_find_template(self):
        ...
        result = find_template(self.template_src, self.template_sch, threshold=0.9, rgb=self.RGB)
        self.assertIsInstance(result, dict)

    def test_func_find_all_template(self):
        """Test find_all_template function in template.py."""
        result = find_all_template(self.template_src, self.template_sch, threshold=0.9, rgb=self.RGB)
        self.assertIsInstance(result, list)
