...
class Microservice(core.Construct):
    ...
    def create_network_load_balancer(self, scope, id, environment, network_load_balancer_ip_1, network_load_balancer_ip_2, network_load_balancer_subnet_1, network_load_balancer_subnet_2):
        ...
        nlb = _alb.NetworkLoadBalancer(self, id + '_nlb',
            ...
            vpc=self.vpc,
            deletion_protection=True if is_production else False,
    ...
    def create_load_balancer(self, scope, id, app_name, environment, environments_parameters, security_group=None, internet_facing=False, load_balancer_name=None, use_cdn=False, main_component_name=None):
        ...
        **kwargs
        ...
        if(is_network_load_balancer):
            ...
            self._tg = self.create_target_group(
                main_component_name, app_name, environment, ec2_traffic_port, ec2_health_check_path, protocol=ec2_traffic_protocol
            )
        ...
        if(is_network_load_balancer):
            ...
            if(network_load_balancer_source_autoscaling_group is not None):
                role = _iam.Role(
                    self,
                    "manage_connection_to_nlb_instance_role",
                    description="manage_connection_to_nlb_instance_role",
                    ...
                    role_name="manage_connection_to_nlb_instance_role",
                )

                role.attach_inline_policy(
                    _iam.Policy(
                        self,
                        "manage_nlb_instance_security_group_policy",
                        statements=[
                            # Policy for EBS
                            _iam.PolicyStatement(
                                actions=[
                ...
                lambda_function = _lambda.Function(self, "manage_connection_to_nlb_instance_security_group_ingress",
