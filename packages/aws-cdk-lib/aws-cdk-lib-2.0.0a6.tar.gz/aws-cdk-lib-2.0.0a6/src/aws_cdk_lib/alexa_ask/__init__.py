...
class CfnSkill(
    ...
    def authentication_configuration(
        ...
        '''
        return typing.cast(typing.Union["CfnSkill.AuthenticationConfigurationProperty", _IResolvable_6e2f5d88], jsii.get(self, "authenticationConfiguration"))
    ...
    def skill_package(
        ...
        '''
        return typing.cast(typing.Union["CfnSkill.SkillPackageProperty", _IResolvable_6e2f5d88], jsii.get(self, "skillPackage"))
    ...
    class SkillPackageProperty:
        ...
        def overrides(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnSkill.OverridesProperty", _IResolvable_6e2f5d88]], result)
...
class CfnSkillProps:
    ...
    def authentication_configuration(
        ...
        return typing.cast(typing.Union[CfnSkill.AuthenticationConfigurationProperty, _IResolvable_6e2f5d88], result)
    ...
    def skill_package(
        ...
        return typing.cast(typing.Union[CfnSkill.SkillPackageProperty, _IResolvable_6e2f5d88], result)
