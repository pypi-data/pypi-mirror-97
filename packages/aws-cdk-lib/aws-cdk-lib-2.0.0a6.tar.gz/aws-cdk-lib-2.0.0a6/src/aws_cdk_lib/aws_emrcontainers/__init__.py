...
class CfnVirtualCluster(
    ...
    def container_provider(
        ...
        '''
        return typing.cast(typing.Union["CfnVirtualCluster.ContainerProviderProperty", _IResolvable_6e2f5d88], jsii.get(self, "containerProvider"))
    ...
    class ContainerInfoProperty:
        ...
        def eks_info(
            ...
            return typing.cast(typing.Union["CfnVirtualCluster.EksInfoProperty", _IResolvable_6e2f5d88], result)
    ...
    class ContainerProviderProperty:
        ...
        def info(
            ...
            return typing.cast(typing.Union["CfnVirtualCluster.ContainerInfoProperty", _IResolvable_6e2f5d88], result)
...
class CfnVirtualClusterProps:
    ...
    def container_provider(
        ...
        return typing.cast(typing.Union[CfnVirtualCluster.ContainerProviderProperty, _IResolvable_6e2f5d88], result)
