...
class CfnFileSystem(
    ...
    def lustre_configuration(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnFileSystem.LustreConfigurationProperty", _IResolvable_6e2f5d88]], jsii.get(self, "lustreConfiguration"))
    ...
    def windows_configuration(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnFileSystem.WindowsConfigurationProperty", _IResolvable_6e2f5d88]], jsii.get(self, "windowsConfiguration"))
    ...
    class WindowsConfigurationProperty:
        ...
        def self_managed_active_directory_configuration(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnFileSystem.SelfManagedActiveDirectoryConfigurationProperty", _IResolvable_6e2f5d88]], result)
...
class CfnFileSystemProps:
    ...
    def lustre_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnFileSystem.LustreConfigurationProperty, _IResolvable_6e2f5d88]], result)
    ...
    def windows_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnFileSystem.WindowsConfigurationProperty, _IResolvable_6e2f5d88]], result)
...
class LustreFileSystemProps(FileSystemProps):
    ...
    def vpc_subnet(self) -> _ISubnet_86847506:
        ...
        return typing.cast(_ISubnet_86847506, result)
...
class _FileSystemBaseProxy(
    FileSystemBase, jsii.proxy_for(_Resource_d91827d0) # type: ignore[misc]
):
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="connections")
    def connections(self) -> _Connections_f2d5652e:
