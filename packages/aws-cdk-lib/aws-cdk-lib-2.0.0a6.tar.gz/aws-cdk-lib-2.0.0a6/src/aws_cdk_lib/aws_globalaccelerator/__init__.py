...
class AcceleratorSecurityGroup(
    ...
    def from_vpc(
        ...
        :stability: experimental
        '''
        return typing.cast(_ISecurityGroup_72429738, jsii.sinvoke(cls, "fromVpc", [scope, id, vpc, endpoint_group]))
...
class CfnEndpointGroup(
    ...
    def endpoint_configurations(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnEndpointGroup.EndpointConfigurationProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "endpointConfigurations"))
    ...
    def port_overrides(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnEndpointGroup.PortOverrideProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "portOverrides"))
...
class CfnEndpointGroupProps:
    ...
    def endpoint_configurations(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnEndpointGroup.EndpointConfigurationProperty, _IResolvable_6e2f5d88]]]], result)
    ...
    def port_overrides(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnEndpointGroup.PortOverrideProperty, _IResolvable_6e2f5d88]]]], result)
...
class CfnListener(
    ...
    def port_ranges(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnListener.PortRangeProperty", _IResolvable_6e2f5d88]]], jsii.get(self, "portRanges"))
...
class CfnListenerProps:
    ...
    def port_ranges(
        ...
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnListener.PortRangeProperty, _IResolvable_6e2f5d88]]], result)
