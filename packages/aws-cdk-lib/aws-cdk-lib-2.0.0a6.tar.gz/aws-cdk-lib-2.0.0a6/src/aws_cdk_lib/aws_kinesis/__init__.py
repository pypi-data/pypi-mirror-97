...
class CfnStream(
    ...
    def stream_encryption(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnStream.StreamEncryptionProperty", _IResolvable_6e2f5d88]], jsii.get(self, "streamEncryption"))
...
class CfnStreamProps:
    ...
    def stream_encryption(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnStream.StreamEncryptionProperty, _IResolvable_6e2f5d88]], result)
