...
class CfnLicense(
    ...
    def consumption_configuration(
        ...
        '''
        return typing.cast(typing.Union["CfnLicense.ConsumptionConfigurationProperty", _IResolvable_6e2f5d88], jsii.get(self, "consumptionConfiguration"))
    ...
    def entitlements(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnLicense.EntitlementProperty", _IResolvable_6e2f5d88]]], jsii.get(self, "entitlements"))
    ...
    def issuer(
        ...
        '''
        return typing.cast(typing.Union["CfnLicense.IssuerDataProperty", _IResolvable_6e2f5d88], jsii.get(self, "issuer"))
    ...
    def validity(
        ...
        '''
        return typing.cast(typing.Union["CfnLicense.ValidityDateFormatProperty", _IResolvable_6e2f5d88], jsii.get(self, "validity"))
    ...
    def license_metadata(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnLicense.MetadataProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "licenseMetadata"))
    ...
    class ConsumptionConfigurationProperty:
        ...
        def borrow_configuration(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnLicense.BorrowConfigurationProperty", _IResolvable_6e2f5d88]], result)
        ...
        def provisional_configuration(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnLicense.ProvisionalConfigurationProperty", _IResolvable_6e2f5d88]], result)
...
class CfnLicenseProps:
    ...
    def consumption_configuration(
        ...
        return typing.cast(typing.Union[CfnLicense.ConsumptionConfigurationProperty, _IResolvable_6e2f5d88], result)
    ...
    def entitlements(
        ...
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnLicense.EntitlementProperty, _IResolvable_6e2f5d88]]], result)
    ...
    def issuer(
        ...
        return typing.cast(typing.Union[CfnLicense.IssuerDataProperty, _IResolvable_6e2f5d88], result)
    ...
    def validity(
        ...
        return typing.cast(typing.Union[CfnLicense.ValidityDateFormatProperty, _IResolvable_6e2f5d88], result)
    ...
    def license_metadata(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnLicense.MetadataProperty, _IResolvable_6e2f5d88]]]], result)
