...
class CfnCustomDataIdentifier(
    ...
    def attr_deleted(self) -> _IResolvable_6e2f5d88:
        ...
        '''
        return typing.cast(_IResolvable_6e2f5d88, jsii.get(self, "attrDeleted"))
...
class CfnFindingsFilter(
    ...
    def attr_findings_filter_list_items(self) -> _IResolvable_6e2f5d88:
        ...
        '''
        return typing.cast(_IResolvable_6e2f5d88, jsii.get(self, "attrFindingsFilterListItems"))
    ...
    def finding_criteria(
        ...
        '''
        return typing.cast(typing.Union["CfnFindingsFilter.FindingCriteriaProperty", _IResolvable_6e2f5d88], jsii.get(self, "findingCriteria"))
    ...
    class FindingCriteriaProperty:
        ...
        def criterion(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnFindingsFilter.CriterionProperty", _IResolvable_6e2f5d88]], result)
...
class CfnFindingsFilterProps:
    ...
    def finding_criteria(
        ...
        return typing.cast(typing.Union[CfnFindingsFilter.FindingCriteriaProperty, _IResolvable_6e2f5d88], result)
