...
class CfnDevice(
    ...
    def location(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnDevice.LocationProperty", _IResolvable_6e2f5d88]], jsii.get(self, "location"))
...
class CfnDeviceProps:
    ...
    def location(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnDevice.LocationProperty, _IResolvable_6e2f5d88]], result)
...
class CfnLink(
    ...
    def bandwidth(
        ...
        '''
        return typing.cast(typing.Union["CfnLink.BandwidthProperty", _IResolvable_6e2f5d88], jsii.get(self, "bandwidth"))
...
class CfnLinkProps:
    ...
    def bandwidth(
        ...
        return typing.cast(typing.Union[CfnLink.BandwidthProperty, _IResolvable_6e2f5d88], result)
...
class CfnSite(
    ...
    def location(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnSite.LocationProperty", _IResolvable_6e2f5d88]], jsii.get(self, "location"))
...
class CfnSiteProps:
    ...
    def location(
        ...
        '''
        result = self._values.get("location")
        return typing.cast(typing.Optional[typing.Union[CfnSite.LocationProperty, _IResolvable_6e2f5d88]], result)
