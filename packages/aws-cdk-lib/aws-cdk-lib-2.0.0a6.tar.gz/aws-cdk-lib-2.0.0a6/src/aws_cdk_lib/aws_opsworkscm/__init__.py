...
class CfnServer(
    ...
    def disable_automated_backup(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]], jsii.get(self, "disableAutomatedBackup"))
    ...
    def engine_attributes(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnServer.EngineAttributeProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "engineAttributes"))
...
class CfnServerProps:
    ...
    def engine_attributes(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnServer.EngineAttributeProperty, _IResolvable_6e2f5d88]]]], result)
