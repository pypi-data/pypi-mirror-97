...
class CfnAttributeGroup(
    ...
    def attributes(
        ...
        '''
        return typing.cast(typing.Union["CfnAttributeGroup.AttributesProperty", _IResolvable_6e2f5d88], jsii.get(self, "attributes"))
...
class CfnAttributeGroupProps:
    ...
    def attributes(
        ...
        return typing.cast(typing.Union[CfnAttributeGroup.AttributesProperty, _IResolvable_6e2f5d88], result)
