...
class CfnSizeConstraintSet(
    ...
    def size_constraints(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnSizeConstraintSet.SizeConstraintProperty", _IResolvable_6e2f5d88]]], jsii.get(self, "sizeConstraints"))
...
class CfnSizeConstraintSetProps:
    ...
    def size_constraints(
        ...
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnSizeConstraintSet.SizeConstraintProperty, _IResolvable_6e2f5d88]]], result)
...
class CfnWebACL(
    ...
    def default_action(
        ...
        '''
        return typing.cast(typing.Union["CfnWebACL.WafActionProperty", _IResolvable_6e2f5d88], jsii.get(self, "defaultAction"))
    ...
    def rules(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnWebACL.ActivatedRuleProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "rules"))
    ...
    class ActivatedRuleProperty:
        ...
        def action(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnWebACL.WafActionProperty", _IResolvable_6e2f5d88]], result)
...
class CfnWebACLProps:
    ...
    def default_action(
        ...
        return typing.cast(typing.Union[CfnWebACL.WafActionProperty, _IResolvable_6e2f5d88], result)
    ...
    def rules(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnWebACL.ActivatedRuleProperty, _IResolvable_6e2f5d88]]]], result)
...
class CfnXssMatchSet(
    ...
    def xss_match_tuples(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnXssMatchSet.XssMatchTupleProperty", _IResolvable_6e2f5d88]]], jsii.get(self, "xssMatchTuples"))
...
class CfnXssMatchSetProps:
    ...
    def xss_match_tuples(
        ...
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnXssMatchSet.XssMatchTupleProperty, _IResolvable_6e2f5d88]]], result)
