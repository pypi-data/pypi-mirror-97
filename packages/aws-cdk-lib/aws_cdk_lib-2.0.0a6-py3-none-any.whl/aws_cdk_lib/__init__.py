...
class _DependableTraitProxy(DependableTrait):
    ...
    def dependency_roots(self) -> typing.List[constructs.IConstruct]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.List[constructs.IConstruct], jsii.get(self, "dependencyRoots"))
...
class _ISynthesisSessionProxy:
    ...
    def assembly(self) -> _CloudAssemblyBuilder_3dc1a20e:
        ...
        :stability: experimental
        '''
        return typing.cast(_CloudAssemblyBuilder_3dc1a20e, jsii.get(self, "assembly"))
...
class Stage(
    ...
    def synth(
        ...
        *,
        ...
        return typing.cast(_CloudAssembly_496ddbf6, jsii.invoke(self, "synth", [options]))
