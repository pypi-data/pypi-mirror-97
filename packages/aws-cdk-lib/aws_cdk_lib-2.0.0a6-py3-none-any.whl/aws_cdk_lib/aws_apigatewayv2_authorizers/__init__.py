...
from ..aws_apigatewayv2 import (
    HttpRouteAuthorizerBindOptions as _HttpRouteAuthorizerBindOptions_eef2ff0c,
    HttpRouteAuthorizerConfig as _HttpRouteAuthorizerConfig_78a15be3,
    IHttpRoute as _IHttpRoute_b43dd68d,
    IHttpRouteAuthorizer as _IHttpRouteAuthorizer_cb279f3f,
)
from ..aws_cognito import (
    IUserPool as _IUserPool_149c8c9a, IUserPoolClient as _IUserPoolClient_76666f44
)


@jsii.implements(_IHttpRouteAuthorizer_cb279f3f)
class HttpJwtAuthorizer(
    ...
    def bind(
        ...
        *,
    ...
    ) -> _HttpRouteAuthorizerConfig_78a15be3:
        ...
        :stability: experimental
        '''
        options = _HttpRouteAuthorizerBindOptions_eef2ff0c(route=route, scope=scope)

        return typing.cast(_HttpRouteAuthorizerConfig_78a15be3, jsii.invoke(self, "bind", [options]))
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_apigatewayv2_authorizers.UserPoolAuthorizerProps",
    jsii_struct_bases=[],
    name_mapping={
        "user_pool": "userPool",
...
class UserPoolAuthorizerProps:
    ...
    def user_pool_client(self) -> _IUserPoolClient_76666f44:
        ...
        return typing.cast(_IUserPoolClient_76666f44, result)
