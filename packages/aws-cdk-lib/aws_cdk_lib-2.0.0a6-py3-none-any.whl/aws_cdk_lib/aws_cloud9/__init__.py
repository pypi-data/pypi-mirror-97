...
class CfnEnvironmentEC2(
    ...
    def repositories(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnEnvironmentEC2.RepositoryProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "repositories"))
...
class CfnEnvironmentEC2Props:
    ...
    def repositories(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnEnvironmentEC2.RepositoryProperty, _IResolvable_6e2f5d88]]]], result)
