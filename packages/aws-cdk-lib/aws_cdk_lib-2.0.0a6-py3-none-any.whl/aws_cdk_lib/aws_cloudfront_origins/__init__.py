...
class HttpOrigin(
    ...
    def _render_custom_origin_config(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_CfnDistribution_79a7f9d0.CustomOriginConfigProperty], jsii.invoke(self, "renderCustomOriginConfig", []))
...
class HttpOriginProps(_OriginProps_5d1b2e69):
    ...
    def origin_ssl_protocols(
        ...
        return typing.cast(typing.Optional[typing.List[_OriginSslPolicy_06fd0d43]], result)
    ...
    def protocol_policy(self) -> typing.Optional[_OriginProtocolPolicy_cc24eeb0]:
        ...
        return typing.cast(typing.Optional[_OriginProtocolPolicy_cc24eeb0], result)
...
class OriginGroup(
    ...
    def bind(
        ...
        *,
        ...
        return typing.cast(_OriginBindConfig_726ad12d, jsii.invoke(self, "bind", [scope, options]))
...
class OriginGroupProps:
    ...
    def fallback_origin(self) -> _IOrigin_ee965ec7:
        ...
        return typing.cast(_IOrigin_ee965ec7, result)
...
class S3OriginProps:
    ...
    def origin_access_identity(
        ...
        return typing.cast(typing.Optional[_IOriginAccessIdentity_6f979fb9], result)
