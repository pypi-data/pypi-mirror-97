...
class CfnProfilingGroup(
    ...
    def anomaly_detection_notification_configuration(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnProfilingGroup.ChannelProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "anomalyDetectionNotificationConfiguration"))
...
class CfnProfilingGroupProps:
    ...
    def anomaly_detection_notification_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnProfilingGroup.ChannelProperty, _IResolvable_6e2f5d88]]]], result)
