...
class CfnGitHubRepository(
    ...
    def code(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnGitHubRepository.CodeProperty", _IResolvable_6e2f5d88]], jsii.get(self, "code"))
    ...
    def enable_issues(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]], jsii.get(self, "enableIssues"))
    ...
    def is_private(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]], jsii.get(self, "isPrivate"))
    ...
    class CodeProperty:
        ...
        def s3(
            ...
            return typing.cast(typing.Union["CfnGitHubRepository.S3Property", _IResolvable_6e2f5d88], result)
...
class CfnGitHubRepositoryProps:
    ...
    def code(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnGitHubRepository.CodeProperty, _IResolvable_6e2f5d88]], result)
