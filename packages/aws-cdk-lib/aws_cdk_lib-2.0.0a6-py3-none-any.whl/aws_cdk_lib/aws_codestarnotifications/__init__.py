...
class CfnNotificationRule(
    ...
    def targets(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnNotificationRule.TargetProperty", _IResolvable_6e2f5d88]]], jsii.get(self, "targets"))
...
class CfnNotificationRuleProps:
    ...
    def targets(
        ...
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnNotificationRule.TargetProperty, _IResolvable_6e2f5d88]]], result)
