...
class CfnNotificationChannel(
    ...
    def config(
        ...
        '''
        return typing.cast(typing.Union["CfnNotificationChannel.NotificationChannelConfigProperty", _IResolvable_6e2f5d88], jsii.get(self, "config"))
    ...
    class NotificationChannelConfigProperty:
        ...
        def sns(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnNotificationChannel.SnsChannelConfigProperty", _IResolvable_6e2f5d88]], result)
...
class CfnNotificationChannelProps:
    ...
    def config(
        ...
        return typing.cast(typing.Union[CfnNotificationChannel.NotificationChannelConfigProperty, _IResolvable_6e2f5d88], result)
...
class CfnResourceCollection(
    ...
    def resource_collection_filter(
        ...
        '''
        return typing.cast(typing.Union["CfnResourceCollection.ResourceCollectionFilterProperty", _IResolvable_6e2f5d88], jsii.get(self, "resourceCollectionFilter"))
    ...
    class ResourceCollectionFilterProperty:
        ...
        def cloud_formation(
            ...
            return typing.cast(typing.Optional[typing.Union["CfnResourceCollection.CloudFormationCollectionFilterProperty", _IResolvable_6e2f5d88]], result)
...
class CfnResourceCollectionProps:
    ...
    def resource_collection_filter(
        ...
        return typing.cast(typing.Union[CfnResourceCollection.ResourceCollectionFilterProperty, _IResolvable_6e2f5d88], result)
