...
class AuthenticateCognitoActionProps:
    ...
    def next(self) -> _ListenerAction_b40b79ed:
        ...
        return typing.cast(_ListenerAction_b40b79ed, result)
    ...
    def user_pool_domain(self) -> _IUserPoolDomain_9cfccfc8:
        ...
        return typing.cast(_IUserPoolDomain_9cfccfc8, result)
    ...
    def on_unauthenticated_request(
        ...
        return typing.cast(typing.Optional[_UnauthenticatedAction_848e589c], result)
