...
from ..aws_kinesisanalytics import CfnApplicationV2 as _CfnApplicationV2_b437f1db
...
class ApplicationCode(
    ...
    jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.ApplicationCode",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.ApplicationCodeConfig",
    jsii_struct_bases=[],
    name_mapping={
...
class ApplicationCodeConfig:
    def __init__(
        self,
        *,
        application_code_configuration_property: _CfnApplicationV2_b437f1db.ApplicationConfigurationProperty,
        bucket: _IBucket_feab190d,
    ) -> None:
        ...
        if isinstance(application_code_configuration_property, dict):
            application_code_configuration_property = _CfnApplicationV2_b437f1db.ApplicationConfigurationProperty(**application_code_configuration_property)
    ...
    def application_code_configuration_property(
        self,
    ) -> _CfnApplicationV2_b437f1db.ApplicationConfigurationProperty:
        ...
        return typing.cast(_CfnApplicationV2_b437f1db.ApplicationConfigurationProperty, result)
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.ApplicationProps",
    jsii_struct_bases=[],
    name_mapping={
        "code": "code",
        "runtime": "runtime",
...
class ApplicationProps:
    def __init__(
        ...
        *,
        ...
        checkpoint_interval: typing.Optional[_Duration_16d61c1f] = None,
        ...
        min_pause_between_checkpoints: typing.Optional[_Duration_16d61c1f] = None,
    ...
    @builtins.property
    def checkpoint_interval(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def min_pause_between_checkpoints(self) -> typing.Optional[_Duration_16d61c1f]:
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.IApplication")
class IApplication(
    _IResource_80e4520a,
    ...
    def add_to_role_policy(
        self,
        policy_statement: _PolicyStatement_68f9b23a,
    ) -> builtins.bool:
...
class _IApplicationProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_kinesisanalytics_flink.IApplication"
...
@jsii.enum(jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.LogLevel")
...
@jsii.enum(jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.MetricsLevel")
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.PropertyGroups",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class Runtime(
    ...
    jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.Runtime",
):
...
class Application(
    _Resource_d91827d0,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_kinesisanalytics_flink.Application",
):
