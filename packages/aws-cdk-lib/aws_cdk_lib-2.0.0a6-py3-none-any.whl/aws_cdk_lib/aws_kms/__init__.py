...
class CfnKey(
    ...
    def enable_key_rotation(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]], jsii.get(self, "enableKeyRotation"))
...
class _IKeyProxy(
    ...
    def add_to_resource_policy(
        ...
        :stability: experimental
        '''
        return typing.cast(_AddToResourcePolicyResult_b426cc8a, jsii.invoke(self, "addToResourcePolicy", [statement, allow_no_op]))
    ...
    def grant_decrypt(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
        ...
        :stability: experimental
        '''
        return typing.cast(_Grant_83432421, jsii.invoke(self, "grantDecrypt", [grantee]))
    ...
    def grant_encrypt(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
        ...
        :stability: experimental
        '''
        return typing.cast(_Grant_83432421, jsii.invoke(self, "grantEncrypt", [grantee]))
    ...
    def grant_encrypt_decrypt(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
        ...
        :stability: experimental
        '''
        return typing.cast(_Grant_83432421, jsii.invoke(self, "grantEncryptDecrypt", [grantee]))
...
class Key(
    ...
    def grant_admin(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
        ...
        :stability: experimental
        '''
        return typing.cast(_Grant_83432421, jsii.invoke(self, "grantAdmin", [grantee]))
    ...
    def _policy(self) -> typing.Optional[_PolicyDocument_ca1df618]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_PolicyDocument_ca1df618], jsii.get(self, "policy"))
...
class KeyProps:
    ...
    def admins(self) -> typing.Optional[typing.List[_IPrincipal_280b818f]]:
        ...
        return typing.cast(typing.Optional[typing.List[_IPrincipal_280b818f]], result)
