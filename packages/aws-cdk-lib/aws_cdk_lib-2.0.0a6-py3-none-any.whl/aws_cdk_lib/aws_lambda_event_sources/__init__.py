...
class S3EventSource(
    ...
    def bucket(self) -> _Bucket_866d2129:
        ...
        :stability: experimental
        '''
        return typing.cast(_Bucket_866d2129, jsii.get(self, "bucket"))
...
class S3EventSourceProps:
    ...
    def events(self) -> typing.List[_EventType_f14ffb73]:
        ...
        return typing.cast(typing.List[_EventType_f14ffb73], result)
    ...
    def filters(self) -> typing.Optional[typing.List[_NotificationKeyFilter_2e2c134a]]:
        ...
        return typing.cast(typing.Optional[typing.List[_NotificationKeyFilter_2e2c134a]], result)
...
class SnsDlq(
    ...
    def bind(
        ...
        :stability: experimental
        '''
        return typing.cast(_DlqDestinationConfig_84601acc, jsii.invoke(self, "bind", [_target, target_handler]))
...
class SnsEventSourceProps(_LambdaSubscriptionProps_9271333e):
    ...
    def filter_policy(
        ...
        return typing.cast(typing.Optional[typing.Mapping[builtins.str, _SubscriptionFilter_3a8bad28]], result)
...
class StreamEventSource(
    ...
    def _enrich_mapping_options(
        ...
        *,
        ...
        return typing.cast(_EventSourceMappingOptions_4d300186, jsii.invoke(self, "enrichMappingOptions", [options]))
...
class StreamEventSourceProps:
    ...
    def starting_position(self) -> _StartingPosition_39042023:
        ...
        return typing.cast(_StartingPosition_39042023, result)
    ...
    def on_failure(self) -> typing.Optional[_IEventSourceDlq_5caed029]:
        ...
        return typing.cast(typing.Optional[_IEventSourceDlq_5caed029], result)
...
class KinesisEventSource(
    ...
    def stream(self) -> _IStream_778702ee:
        ...
        :stability: experimental
        '''
        return typing.cast(_IStream_778702ee, jsii.get(self, "stream"))
