...
class CfnJobTemplate(
    ...
    def acceleration_settings(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnJobTemplate.AccelerationSettingsProperty", _IResolvable_6e2f5d88]], jsii.get(self, "accelerationSettings"))
    ...
    def hop_destinations(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnJobTemplate.HopDestinationProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "hopDestinations"))
...
class CfnJobTemplateProps:
    ...
    def acceleration_settings(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnJobTemplate.AccelerationSettingsProperty, _IResolvable_6e2f5d88]], result)
    ...
    def hop_destinations(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnJobTemplate.HopDestinationProperty, _IResolvable_6e2f5d88]]]], result)
