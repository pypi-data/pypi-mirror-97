...
class CfnStream(
    ...
    def kinesis_configuration(
        ...
        '''
        return typing.cast(typing.Union["CfnStream.KinesisConfigurationProperty", _IResolvable_6e2f5d88], jsii.get(self, "kinesisConfiguration"))
...
class CfnStreamProps:
    ...
    def kinesis_configuration(
        ...
        return typing.cast(typing.Union[CfnStream.KinesisConfigurationProperty, _IResolvable_6e2f5d88], result)
