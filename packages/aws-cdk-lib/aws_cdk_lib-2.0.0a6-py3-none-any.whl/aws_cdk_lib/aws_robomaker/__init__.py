...
class CfnRobotApplication(
    ...
    def robot_software_suite(
        ...
        '''
        return typing.cast(typing.Union["CfnRobotApplication.RobotSoftwareSuiteProperty", _IResolvable_6e2f5d88], jsii.get(self, "robotSoftwareSuite"))
    ...
    def sources(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnRobotApplication.SourceConfigProperty", _IResolvable_6e2f5d88]]], jsii.get(self, "sources"))
...
class CfnRobotApplicationProps:
    ...
    def robot_software_suite(
        ...
        return typing.cast(typing.Union[CfnRobotApplication.RobotSoftwareSuiteProperty, _IResolvable_6e2f5d88], result)
    ...
    def sources(
        ...
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnRobotApplication.SourceConfigProperty, _IResolvable_6e2f5d88]]], result)
...
class CfnSimulationApplication(
    ...
    def rendering_engine(
        ...
        '''
        return typing.cast(typing.Union["CfnSimulationApplication.RenderingEngineProperty", _IResolvable_6e2f5d88], jsii.get(self, "renderingEngine"))
    ...
    def robot_software_suite(
        ...
        '''
        return typing.cast(typing.Union["CfnSimulationApplication.RobotSoftwareSuiteProperty", _IResolvable_6e2f5d88], jsii.get(self, "robotSoftwareSuite"))
    ...
    def simulation_software_suite(
        ...
        '''
        return typing.cast(typing.Union["CfnSimulationApplication.SimulationSoftwareSuiteProperty", _IResolvable_6e2f5d88], jsii.get(self, "simulationSoftwareSuite"))
    ...
    def sources(
        ...
        '''
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnSimulationApplication.SourceConfigProperty", _IResolvable_6e2f5d88]]], jsii.get(self, "sources"))
...
class CfnSimulationApplicationProps:
    ...
    def rendering_engine(
        ...
        return typing.cast(typing.Union[CfnSimulationApplication.RenderingEngineProperty, _IResolvable_6e2f5d88], result)
    ...
    def robot_software_suite(
        ...
        result = self._values.get("robot_software_suite")
        assert result is not None, "Required property 'robot_software_suite' is missing"
        return typing.cast(typing.Union[CfnSimulationApplication.RobotSoftwareSuiteProperty, _IResolvable_6e2f5d88], result)
    ...
    def simulation_software_suite(
        ...
        return typing.cast(typing.Union[CfnSimulationApplication.SimulationSoftwareSuiteProperty, _IResolvable_6e2f5d88], result)
    ...
    def sources(
        ...
        result = self._values.get("sources")
        assert result is not None, "Required property 'sources' is missing"
        return typing.cast(typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnSimulationApplication.SourceConfigProperty, _IResolvable_6e2f5d88]]], result)
