...
class CfnSigningProfile(
    ...
    def signature_validity_period(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnSigningProfile.SignatureValidityPeriodProperty", _IResolvable_6e2f5d88]], jsii.get(self, "signatureValidityPeriod"))
...
class CfnSigningProfileProps:
    ...
    def signature_validity_period(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnSigningProfile.SignatureValidityPeriodProperty, _IResolvable_6e2f5d88]], result)
...
class ISigningProfile(_IResource_80e4520a, typing_extensions.Protocol):
...
class SigningProfile(
    ...
    def __init__(
        ...
        *,
        platform: Platform,
        signature_validity: typing.Optional[_Duration_16d61c1f] = None,
...
class SigningProfileProps:
    ...
    @builtins.property
    def signature_validity(self) -> typing.Optional[_Duration_16d61c1f]:
