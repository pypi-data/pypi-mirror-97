...
class CfnServer(
    ...
    def endpoint_details(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnServer.EndpointDetailsProperty", _IResolvable_6e2f5d88]], jsii.get(self, "endpointDetails"))
    ...
    def identity_provider_details(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnServer.IdentityProviderDetailsProperty", _IResolvable_6e2f5d88]], jsii.get(self, "identityProviderDetails"))
...
class CfnServerProps:
    ...
    def endpoint_details(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnServer.EndpointDetailsProperty, _IResolvable_6e2f5d88]], result)
    ...
    def identity_provider_details(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnServer.IdentityProviderDetailsProperty, _IResolvable_6e2f5d88]], result)
...
class CfnUser(
    ...
    def home_directory_mappings(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnUser.HomeDirectoryMapEntryProperty", _IResolvable_6e2f5d88]]]], jsii.get(self, "homeDirectoryMappings"))
    ...
    def posix_profile(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnUser.PosixProfileProperty", _IResolvable_6e2f5d88]], jsii.get(self, "posixProfile"))
...
class CfnUserProps:
    ...
    def home_directory_mappings(
        ...
        return typing.cast(typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union[CfnUser.HomeDirectoryMapEntryProperty, _IResolvable_6e2f5d88]]]], result)
    ...
    def posix_profile(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnUser.PosixProfileProperty, _IResolvable_6e2f5d88]], result)
