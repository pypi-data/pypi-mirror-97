...
class CfnConnectionAlias(
    ...
    def attr_associations(self) -> _IResolvable_6e2f5d88:
        ...
        '''
        return typing.cast(_IResolvable_6e2f5d88, jsii.get(self, "attrAssociations"))
...
class CfnWorkspace(
    ...
    def root_volume_encryption_enabled(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]], jsii.get(self, "rootVolumeEncryptionEnabled"))
    ...
    def user_volume_encryption_enabled(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]], jsii.get(self, "userVolumeEncryptionEnabled"))
    ...
    def workspace_properties(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnWorkspace.WorkspacePropertiesProperty", _IResolvable_6e2f5d88]], jsii.get(self, "workspaceProperties"))
...
class CfnWorkspaceProps:
    ...
    def workspace_properties(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnWorkspace.WorkspacePropertiesProperty, _IResolvable_6e2f5d88]], result)
