...
from .. import (
    ...
    Reference as _Reference_766c2e2d,
)
...
class AwsCustomResource(
    ...
    def get_response_field_reference(
        ...
        :stability: experimental
        '''
        return typing.cast(_Reference_766c2e2d, jsii.invoke(self, "getResponseFieldReference", [data_path]))
...
class AwsCustomResourcePolicy(
    ...
    def statements(self) -> typing.List[_PolicyStatement_68f9b23a]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.List[_PolicyStatement_68f9b23a], jsii.get(self, "statements"))
...
class PhysicalResourceIdReference(
    ...
    def resolve(self, _: _IResolveContext_420a7d81) -> typing.Any:
...
class Provider(
    ...
    def bind(self, _: constructs.Construct) -> _CustomResourceProviderConfig_dad9ffe4:
        ...
        '''
        return typing.cast(_CustomResourceProviderConfig_dad9ffe4, jsii.invoke(self, "bind", [_]))
    ...
    def on_event_handler(self) -> _IFunction_9c701b6f:
        ...
        :stability: experimental
        '''
        return typing.cast(_IFunction_9c701b6f, jsii.get(self, "onEventHandler"))
    ...
    def is_complete_handler(self) -> typing.Optional[_IFunction_9c701b6f]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_IFunction_9c701b6f], jsii.get(self, "isCompleteHandler"))
