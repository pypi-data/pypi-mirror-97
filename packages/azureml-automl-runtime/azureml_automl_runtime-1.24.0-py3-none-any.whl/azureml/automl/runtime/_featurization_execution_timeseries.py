...
def split_and_featurize_data_timeseries(
    ...
    time_colname = raw_data_context.timeseries_param_dict.get(constants.TimeSeries.TIME_COLUMN_NAME)  # type:ignore
    ...
    ts_param_dict_copy = raw_data_context.timeseries_param_dict.copy()  # type: ignore
    ...
    if ts_transformer:
        if transformed_data_context.cv_splits.get_cv_split_indices() is not None:
            ...
            for X_train, y_train, sample_wt_train, X_valid, y_valid, sample_wt_valid \
                ...
                ts_split_param_dict = raw_data_context.timeseries_param_dict.copy()  # type: ignore
