...
from azureml.automl.runtime._ml_engine.validation import AbstractRawExperimentDataValidator, RawExperimentDataValidator
...
def validate(raw_experiment_data: RawExperimentData, automl_settings: AutoMLBaseSettings) -> None:
    ...
    if automl_settings.enable_streaming:
        experiment_data_validator = StreamingExperimentDataValidator(automl_settings)
    else:
