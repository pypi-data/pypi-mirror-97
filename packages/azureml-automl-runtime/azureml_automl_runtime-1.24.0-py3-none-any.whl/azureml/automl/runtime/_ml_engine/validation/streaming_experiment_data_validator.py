...
from azureml.automl.runtime._ml_engine.validation import MaterializedTabularDataValidator, RawExperimentDataValidator
...
class StreamingExperimentDataValidator(RawExperimentDataValidator):
    ...
    def __init__(self, automl_settings: AutoMLBaseSettings):
        super(StreamingExperimentDataValidator, self).__init__(automl_settings)

        self.label_column_name = cast(str, automl_settings.label_column_name)  # type: str
        self.weight_column_name = automl_settings.weight_column_name  # type: Optional[str]
        self.validation_size = automl_settings.validation_size or 0.0  # type: float
    ...
    def get_tabular_data_validator(self) -> MaterializedTabularDataValidator:
        ...
        return StreamingTabularDataValidator(
            ...
            is_featurization_required=self._automl_settings.featurization != FeaturizationConfigMode.Off,
        )
