...
class DataTransformer(AutoMLTransformer, FeaturizationInfoProvider):
    ...
    def __init__(
        ...
        self.logger = _logger  # For backward compatibility.
    ...
    def _set_is_text_dnn_if_available(
            self, transformer_mapper: TransformerAndMapper
    ) -> bool:
    ...
    def __setstate__(self, state):
        ...
        new_data_transformer.logger = module_logger
        global _logger
