...
class DataPreparer(ABC):
    ...
    def prepare_raw_experiment_data(self,
        ...
        return RawExperimentData.create(datasets, automl_settings_obj)
...
class DataPreparerFactory:
    ...
    def get_preparer(dataprep_json: str) -> DataPreparer:
        ...
        try:
            ...
            logger.info('Successfully retrieved data using {}.'.format(type(data_preparer.__class__.__name__)))
