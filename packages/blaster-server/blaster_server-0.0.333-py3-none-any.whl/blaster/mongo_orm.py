...
class Model(object):
	...
	#hook that calls on newly created objects
	...
	#hooks that calls before update and create
	def before_update(self):
		pass

	#hook that calls after every create and update
