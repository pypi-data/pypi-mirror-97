...
class Intersection:
    ...
    def IntersectionPointsFind(self, start_lat1, start_lon1, theta1, start_lat2, start_lon2, theta2):
        ...
        # because the heading calculation in requests from the web can be float,
        # and the one from the database can be decimal.
        if isinstance(ops1["lat"], decimal.Decimal):
            ops1["lat"], ops1["lon"], \
            ops2["lat"], ops2["lon"] = self.intersection_decimal_to_float(ops1["lat"],
                                                                                ops1["lon"],
                                                                                ops2["lat"],
                                                                                ops2["lon"])
    ...
    @staticmethod
    def intersection_decimal_to_float(lat1, lon1, lat2, lon2):
        """
