...
setup(
  ...
  download_url = 'https://github.com/zenarcher007/calcwave/archive/v1.0.0b3.tar.gz',
  keywords = ['cross-platform', 'audio syntheses', 'terminal'],   # Keywords that define your package best
  install_requires=[
    'pyaudio',
    'numpy',
    'argparse',
