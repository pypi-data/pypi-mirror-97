...
_WRITEAHEADLOGENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='third_party_log_entry', full_name='calixa.domain.log.WriteAheadLogEntry.third_party_log_entry', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='first_party_log_entry', full_name='calixa.domain.log.WriteAheadLogEntry.first_party_log_entry', index=8,
