...
class MosaicAddressRestrictionEntryBuilder:
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> MosaicAddressRestrictionEntryBuilder:
        ...
        keyPairs = AddressKeyValueSetBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1
    ...
    def getKeyPairs(self) -> AddressKeyValueSetBuilder:
