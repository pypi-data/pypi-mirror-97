...
class ProofVerificationHashDto:
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> ProofVerificationHashDto:
        ...
        proofVerificationHash = GeneratorUtils.getBytes(bytes_, 16)
    ...
    def getProofVerificationHash(self) -> bytes:
    ...
    def serialize(self) -> bytes:
        ...
        """
        bytes_ = bytes()
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, self.proofVerificationHash)
        return bytes_
