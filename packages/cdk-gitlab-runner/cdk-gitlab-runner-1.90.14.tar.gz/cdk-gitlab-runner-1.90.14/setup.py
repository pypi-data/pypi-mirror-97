    ...
    """
{
    ...
    "package_data": {
        "cdk_gitlab_runner._jsii": [
            "cdk-gitlab-runner@1.90.14.jsii.tgz"
        ],
        "cdk_gitlab_runner": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-autoscaling-hooktargets>=1.90.0, <2.0.0",
        "aws-cdk.aws-autoscaling>=1.90.0, <2.0.0",
        ...
        "aws-cdk.aws-sns-subscriptions>=1.90.0, <2.0.0",
