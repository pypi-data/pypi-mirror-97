...
class CloudShellAPISession(CommonAPISession):
    ...
    def CreateImmediateReservation(self, reservationName='', owner='', durationInMinutes=0, notifyOnStart=False, notifyOnEnd=False, notificationMinutesBeforeEnd=0, reserveWithConflicts=True):
        """
            ...
            :param bool reserveWithConflicts: Allows Reservation creation with unresolved resources

            :rtype: CreateReservationResponseInfo
        """
        return self.generateAPIRequest(OrderedDict([('method_name', 'CreateImmediateReservation'), ('reservationName', reservationName), ('owner', owner), ('durationInMinutes', durationInMinutes), ('notifyOnStart', notifyOnStart), ('notifyOnEnd', notifyOnEnd), ('notificationMinutesBeforeEnd', notificationMinutesBeforeEnd), ('reserveWithConflicts', reserveWithConflicts)]))

    def CreateImmediateTopologyReservation(self, reservationName='', owner='', durationInMinutes=0, notifyOnStart=False, notifyOnEnd=False, notificationMinutesBeforeEnd=0, topologyFullPath='', globalInputs=[], requirementsInputs=[], additionalInfoInputs=[], notifyOnSetupComplete=False, reserveWithConflicts=True):
        """
    ...
    def CreateTopologyReservation(self, reservationName='', owner='', startTime='', endTime='', notifyOnStart=False, notifyOnEnd=False, notificationMinutesBeforeEnd=0, topologyFullPath='', globalInputs=[], requirementsInputs=[], additionalInfoInputs=[], notifyOnSetupComplete=False, isSendToReservationEngine=False, recurrence='', requestedResources='', permittedUsers=[], reserveWithConflicts=True):
        """
            Defines a new reservation.
          ...
          doesnotcontain hi there
            ...
            :param list[UpdateTopologyAdditionalInfoInputsRequest] additionalInfoInputs: Additional info inputs associated with the specified topology. 
            :param bool notifyOnSetupComplete: Indicate whether to notify the reservation owner when the reservation setup completes.
            :param bool isSendToReservationEngine: Forces creation of reservation on server without using job scheduling.
            :param str recurrence: Formatted string of recurrence request configuration
            :param str requestedResources: JSON string containing additional resources
            :param list[str] permittedUsers: List of Usernames to be granted permission on reservations
            :param bool reserveWithConflicts: Allows Reservation creation with unresolved resources

            :rtype: CreateReservationResponseInfo
        """
        return self.generateAPIRequest(OrderedDict([('method_name', 'CreateReservation'), ('reservationName', reservationName), ('owner', owner), ('startTime', startTime), ('endTime', endTime), ('notifyOnStart', notifyOnStart), ('notifyOnEnd', notifyOnEnd), ('notificationMinutesBeforeEnd', notificationMinutesBeforeEnd), ('topologyFullPath', topologyFullPath), ('globalInputs', CommonAPIRequest.toContainer(globalInputs)), ('requirementsInputs', CommonAPIRequest.toContainer(requirementsInputs)), ('additionalInfoInputs', CommonAPIRequest.toContainer(additionalInfoInputs)), ('notifyOnSetupComplete', notifyOnSetupComplete), ('isSendToReservationEngine', isSendToReservationEngine), ('recurrence', recurrence), ('requestedResources', requestedResources), ('permittedUsers', permittedUsers), ('reserveWithConflicts', reserveWithConflicts)]))
