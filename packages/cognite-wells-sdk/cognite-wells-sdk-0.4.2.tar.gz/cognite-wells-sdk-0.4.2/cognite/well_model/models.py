...
class TypeAndName(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    wellbore: Optional[str] = Field(
        None, description="if set this is set, source parent is type well", example="name-of-parent"
    )
    well: Optional[str] = Field(
        None, description="if set this is set, source parent is type wellbore", example="name-of-parent"
    )
...
class WellDatum(WellsBaseModel):
    ...
    elevation: float = Field(..., example=1)
    unit: str = Field(..., example="Example")
...
class SourceWithIds(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True

    dataset_external_id: Optional[str] = Field(None, alias="datasetExternalId")
    source: str
    external_ids: Optional[List[str]] = Field(None, alias="externalIds")
...
class Well(WellsBaseModel):
    ...
    water_depth: Optional[float] = Field(None, alias="waterDepth", description="Water depth in meters", example=1)
    well_head: Optional[WellHead] = Field(None, alias="wellHead")
...
class WellIngestion(WellsBaseModel):
    ...
    field: Optional[str] = Field(None, example="Example")
    operator: Optional[str] = Field(None, example="Op1")
    water_depth: Optional[int] = Field(None, alias="waterDepth", description="Water depth in meters", example=1)
    well_head: WellHead = Field(..., alias="wellHead")
    datum: WellDatum
...
class WellboreIngestion(WellsBaseModel):
    ...
    source: str = Field(..., description="name of the source system")
    source_asset_id: int = Field(..., alias="sourceAssetId", description="id of the corresponding CDF asset", example=1)
    source_name: str = Field(..., alias="sourceName", example="25/5-5")
    source_parent_type_and_name: TypeAndName = Field(..., alias="sourceParentTypeAndName")
...
class CasingIngestion(WellsBaseModel):
    ...
    assembly_size: DoubleArrayWithUnit = Field(..., alias="assemblySize")
    assembly_type: Optional[List[str]] = Field(None, alias="assemblyType")
    md_assembly_top: DoubleArrayWithUnit = Field(..., alias="mdAssemblyTop")
    md_assembly_base: DoubleArrayWithUnit = Field(..., alias="mdAssemblyBase")
    tvd_assembly_top: Optional[DoubleArrayWithUnit] = Field(None, alias="tvdAssemblyTop")
    tvd_assembly_base: Optional[DoubleArrayWithUnit] = Field(None, alias="tvdAssemblyBase")
