...
setup(
 ...
 '\n'    
 'SKIP DOC: Subclass of `TagSetCriterion` requiring an `.sql_parameters` '    
 'method\n'    
 ...
 '\n'    
 'SKIP DOC: A `cs.tagset.TagBasedTest` extended with a `.sql_parameters` '    
 'method.\n'    
 '\n'    
 ...
 'Initial release.'),
  ...
  install_requires = ['cs.cmdutils', 'cs.context', 'cs.dateutils', 'cs.deco', 'cs.fileutils', 'cs.lex', 'cs.logutils', 'cs.obj', 'cs.pfx', 'cs.sqlalchemy_utils', 'cs.tagset', 'cs.threads>=20201025', 'cs.upd', 'icontract', 'sqlalchemy', 'typeguard'],
  keywords = ['python3'],
