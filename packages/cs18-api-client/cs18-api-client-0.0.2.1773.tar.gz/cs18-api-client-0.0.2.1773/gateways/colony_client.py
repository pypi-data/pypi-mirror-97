...
from gateways.common.cs18_api_classes import BlueprintRepositoryDetails, AccessLink, \
    ...
    AddBlueprintBitbucketRepositoryRequest
...
from common.bitbucket_gateway import BitbucketGateway
...
class Colony:
    ...
    def add_repository_to_space(
        ...
        if repository_details.auth_code is not None:
            ...
            request = {
                ...
                "code": repository_details.auth_code,
