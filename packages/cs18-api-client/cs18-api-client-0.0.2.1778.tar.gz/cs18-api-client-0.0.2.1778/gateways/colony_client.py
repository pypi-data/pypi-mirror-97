...
from gateways.bitbucket_gateway import BitbucketGateway
...
class Colony:
    ...
    def add_repository_to_space(
        ...
        if isinstance(repository_details, BitbucketBlueprintRepositoryDetails):
            repository_details.code = self.get_auth_code_from_bitbucket(repository_details)
    ...
    @staticmethod
    def get_auth_code_from_bitbucket(repository_details):
        with BitbucketGateway(
                username=repository_details.username,
                password=repository_details.password,
                client_email=repository_details.client_email,
                client_id=repository_details.client_id,
                redirect_url=repository_details.redirect_url) as bitbucket:
            return bitbucket.get_consumer_app_temporary_code()
