...
* **With CubicWeb Views:**
  ...
  :doc:`Facets (is this thing still used?) <>` |
...
* **Migrations:**
  :doc:`script migration <book/admin/migration>` |
  :doc:`Write script migration <>` |
  :doc:`Execute script migration <>` |
...
* **Deployment:**
  :doc:`Raw python deployment <>` |
  :doc:`Working with Docker <>` |
  :doc:`Working with debian packages <>`

* **Administration:**
  :doc:`the cubicweb-ctl tool <>` |
...
.. _`matrix room`: https://riot.im/app/#/room/!XzActAZxIwtgeZpKTk:matrix.logilab.org
