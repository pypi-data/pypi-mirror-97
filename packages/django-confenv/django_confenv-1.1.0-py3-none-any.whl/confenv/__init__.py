...
class Env(object):
  ...
  def makecase(self, var):
    try:
      mode = object.__getattribute__(self, 'case')
      if mode == Env.IGNORE: return var
      if mode == Env.UPPER:  return var.upper()
      if mode == Env.LOWER:  return var.lower()
