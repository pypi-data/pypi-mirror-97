...
from dlms_cosem.a_xdr import EncodingConf, Attribute, Sequence, \
    AXdrDecoder, DlmsDataToPythonConverter
from dlms_cosem.dlms_data import BaseDlmsData, DateTimeData, OctetStringData
...
class GeneralGlobalCipherApdu:
    ...
    ENCODING_CONF = EncodingConf([
        Attribute(attribute_name='system_title',
                  instance_class=OctetStringData, return_value=True),
        Attribute(attribute_name='ciphered_content',
...
class NotificationBody:
    ...
    data: typing.List[BaseDlmsData] = attr.ib(default=None)
...
class DataNotificationApdu:
    ...
    ENCODING_CONF = EncodingConf(attributes=[
        Attribute(attribute_name='long_invoke_id_and_priority',
                  instance_class=LongInvokeIdAndPriority, length=4),
        Attribute(attribute_name='date_time',
                  instance_class=DateTimeData, optional=True,
                  length=12),
        Attribute(attribute_name='notification_body',
