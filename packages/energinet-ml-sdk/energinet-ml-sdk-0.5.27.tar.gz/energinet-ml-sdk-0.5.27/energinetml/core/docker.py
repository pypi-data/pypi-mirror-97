...
def build_prediction_api_docker_image(
        path, tag, trained_model_file_path,
    ...
    :param typing.Optional[str] extra_index_url: PIP extra index URL
    :param typing.Optional[str] model_version: Model version (for logging)
    """
    ...
    if extra_index_url:
        command.extend(('--build-arg', 'EXTRA_INDEX_URL=%s' % extra_index_url))
    if model_version:
