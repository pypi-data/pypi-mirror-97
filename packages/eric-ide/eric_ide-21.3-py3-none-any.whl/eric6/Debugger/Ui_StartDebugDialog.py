...
class Ui_StartDebugDialog(object):
    def setupUi(self, StartDebugDialog):
        ...
        StartDebugDialog.resize(550, 335)
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.multiprocessGroup)
        ...
        self.horizontalLayout_2.addWidget(self.multiprocessNoDebugCombo)
        self.verticalLayout.addWidget(self.multiprocessGroup)
