...
class VIEW3D_MT_edit_text_context_menu(bpy_types.Menu, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class VIEW3D_PT_overlay_paint(bpy_types.Panel, bpy_types._GenericUI):
    bl_label = None
    ''' '''
...
class VIEW3D_PT_pivot_point(bpy_types.Panel, bpy_types._GenericUI):
    bl_label = None
    ''' '''
