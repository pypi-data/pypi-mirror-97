...
class DATA_PT_gpencil_layer_adjustments(LayerDataButtonsPanel, bpy_types.Panel,
                                        bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class DATA_PT_gpencil_layer_display(LayerDataButtonsPanel, bpy_types.Panel,
                                    bpy_types._GenericUI):
    bl_context = None
    ''' '''
...
class DATA_PT_gpencil_layer_relations(LayerDataButtonsPanel, bpy_types.Panel,
                                      bpy_types._GenericUI):
    bl_context = None
    ''' '''
