...
const Tag = ({name, color = "blue", selected = false, triangle = false}) => {
  ...
  return /* @__PURE__ */ React.createElement(OuterRectangle, {
    borderColor: color,
    hasTriangle: triangle
  }, triangle ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(OuterTriangle, {
    borderColor: color
  }), /* @__PURE__ */ React.createElement(InnerTriangle, {
    fillColor
  })) : null, /* @__PURE__ */ React.createElement(InnerRectangle, {
    hasTriangle: triangle,
    fillColor,
