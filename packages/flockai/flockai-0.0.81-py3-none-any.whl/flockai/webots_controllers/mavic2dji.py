...
class KeyboardMavic2DJI(KeyboardControlledDrone):
    ...
    def run(self):
        ...
        while self.step(self.basic_time_step) != -1:
            ...
            io_time = 0 if probe_io_time.get_val() is None else probe_io_time.get_val()
            ...
            input_vector = np.array([[temperature_max], [temperature_min], [temperature_avg], [humidity_max], [humidity_min], [humidity_avg]])
