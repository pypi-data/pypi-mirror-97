...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" onclick="stopPropagation(event);" class="' + search_init + sCSSClass + '" value="' + inputvalue + '" rel="' + i + '"/>');
            ...
            if (bIsNumber && !oTable.fnSettings().oFeatures.bServerSide) {
                input.keyup($.debounce(650, function() { //Was - 20160407 input.keyup(function () {
