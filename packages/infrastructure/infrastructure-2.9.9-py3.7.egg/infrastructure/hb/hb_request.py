...
# @Last Modified time: 2021-03-08 20:12:04
import os
	...
	def getBussinessServiceName(self,teamList,helloBikeToken,user_agent,user="",isServer=True):
		...
		if response['status']:
			...
			for team in infos:
				...
				temp['service_name'] = team['name']
				temp['description'] = team['description']
				temp['lang'] = team['lang']
				temp['level'] = team['level']
				temp['team_leader'] = team.get("user","")
				temp['team_leader_email'] = team.get('user_name',"none@example.cn")
				temp['ci_case'] = team['case']
				temp['is_container'] = team['is_container']
				temp['system_aliases'] = team.get('system_aliases',"")
				temp['system_description'] = team['system']
				temp['call_applist'] = team.get('call_applist',"")
				temp['os_type'] = team.get('call_applist',"")
