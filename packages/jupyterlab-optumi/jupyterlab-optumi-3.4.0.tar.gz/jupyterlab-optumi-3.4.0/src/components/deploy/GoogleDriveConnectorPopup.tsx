...
export class GoogleDriveConnectorPopup extends React.Component<IProps, IState> {
    ...
    public render = (): JSX.Element => {
        if (Global.shouldLogOnRender) console.log('GoogleDriveConnectorPopupRender (' + new Date().getSeconds() + ')');
        return (
                    ...
                    <DialogContent style={{padding: '0px'}}>
                        <div style={{padding: '12px'}}>
                            <div style={{margin: '12px 18px 18px 18px'}}>
                                Connect to a Google Drive file using a Service Account.
                            </div>
                            <TextBox<string>
                            ...
                            <TextBox<string>
                                ...
                                saveValue={(value: string) => this.setState({ fileID: value })}
                                label='File ID'
