...
DATA_PATH = os.path.join(str(Path.home()), '.kolibri_dnn')
...
class Config(object):
    ...
    def __init__(self):
        ...
        if tf.test.is_gpu_available(cuda_only=True):
            logging.warning("CUDA GPU available, you can set `kolibri_dnn.config.use_cudnn_cell = True` to use CuDNNCell. "
