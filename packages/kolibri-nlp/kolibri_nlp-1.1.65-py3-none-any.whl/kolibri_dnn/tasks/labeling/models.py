...
from kolibri_dnn.tasks.labeling.base_model import BaseLabelingModel
from kolibri_dnn.layers import L
from kolibri_dnn.layers.crf import CRF

from kolibri_dnn.utils import custom_objects
...
if __name__ == "__main__":
    ...
    from kolibri_dnn.corpus import CONLL2003ENCorpus

    conll1=CONLL2003ENCorpus(subset_name='train', task_name='ner')
    conll2=CONLL2003ENCorpus(subset_name='test', task_name='ner')

    train_ds=conll1.get_conll_dataset()
    test_ds=conll2.get_conll_dataset()
    model = BiLSTM_CRF_Model()


    model.fit(train_ds, test_ds, epochs=6, batch_size=64)
    conll = CONLL2003ENCorpus(subset_name='valid', task_name='ner')

    x_valid, y_valid =conll.get_conll_dataset().get_data()
