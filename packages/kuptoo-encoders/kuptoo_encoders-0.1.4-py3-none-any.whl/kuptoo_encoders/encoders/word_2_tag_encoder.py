...
if __name__ == "__main__":
    ...
    wae = Word2TagEncoder(16, measures_tag + annotation_tags, smooth=.2, smooth_per_class={
        "products": 0
    })
    title = "zielony kapsle na monety 21mm / 100 sztuk 1askkda apple air"
    words = title.split()
    a = wae.encode(
        (title,
         {"color": ["zielony"],
