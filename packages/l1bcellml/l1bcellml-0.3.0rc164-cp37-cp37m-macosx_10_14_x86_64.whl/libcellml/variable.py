...
class Variable(libcellml.namedentity.NamedEntity):
    ...
    def removeEquivalenceConnectionId(variable1, variable2):
        r"""Remove the connection id for the equivalence defined with the given variables."""
    ...
    def removeEquivalenceMappingId(variable1, variable2):
        r"""Remove the mapping id for the equivalence defined with the given variables."""
