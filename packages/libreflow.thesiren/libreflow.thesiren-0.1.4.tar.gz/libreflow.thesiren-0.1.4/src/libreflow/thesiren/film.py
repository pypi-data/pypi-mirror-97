...
class BuildLayoutScene(RunAction):
    ...
    def extra_argv(self):
        ...
        frame_start = 101
        frame_end = 101 + self._shot_data.get("nb_frames", 0)
        resolution_x = 2048
        resolution_y = 858
        fps = 24
        ...
        blender_operators["setup"](frame_start=frame_start, frame_end=frame_end, resolution_x=resolution_x, resolution_y=resolution_y, fps=fps)
