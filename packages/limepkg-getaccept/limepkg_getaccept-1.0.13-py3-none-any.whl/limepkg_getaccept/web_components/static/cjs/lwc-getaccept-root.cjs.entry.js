...
const Root = class {
    ...
    render() {
        return [
            ...
            index.h("limel-dialog", { open: this.isOpen, closingActions: { escapeKey: false, scrimClick: false }, onClose: () => {
                    this.isOpen = false;
    ...
    renderLogo(compact) {
        ...
        return (index.h("div", { class: classes }, index.h("img", { onClick: () => (this.activeView = EnumViews.EnumViews.home), src: "getaccept/logos/logo-inverted", class: "logo" })));
    }
    showWorkflow() {
