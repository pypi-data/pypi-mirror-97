...
var Root = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return [
            ...
            h("limel-dialog", { open: this.isOpen, closingActions: { escapeKey: false, scrimClick: false }, onClose: function () {
                    _this.isOpen = false;
    ...
    class_1.prototype.renderLogo = function (compact) {
        ...
        return (h("div", { class: classes }, h("img", { onClick: function () { return (_this.activeView = EnumViews.home); }, src: "getaccept/logos/logo-inverted", class: "logo" })));
    };
