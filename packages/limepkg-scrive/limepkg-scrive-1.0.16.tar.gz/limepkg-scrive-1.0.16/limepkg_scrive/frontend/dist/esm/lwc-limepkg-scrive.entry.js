import { r as registerInstance, h, g as getElement } from './core-d389d3ab.js';
...
const Test = class {
    ...
    render() {
        ...
        return (h("div", null, h("limel-collapsible-section", { header: "Sign with Scrive" }, h("limel-button", { label: `Design Contract`, outlined: true, onClick: () => this.goToScrive(this.context.id) }), h("limel-checkbox", { label: "Add associated person as signing party", id: "fab", checked: this.includePerson, required: false, onChange: () => this.includePerson = !this.includePerson }))));
    }
