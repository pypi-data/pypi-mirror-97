...
class ProductVariantTestCase(ModuleTestCase):
    ...
    def test_call_template_list_price(self):
        ...
        list_price = template1.list_price
    ...
    def test_product_names(self):
        ...
        product1, product2, product3, product4 = Product.search([])
    ...
    @with_transaction()
    def test_product_list_price(self):
        'Test product list price'
        pool = Pool()
        Template = pool.get('product.template')
        Product = pool.get('product.product')
        Uom = pool.get('product.uom')
        ...
        self.assertEqual(product1.list_price, Decimal('10'))
        self.assertEqual(product2.list_price, Decimal('15'))
        self.assertEqual(product1.list_price_used, Decimal('10'))
        self.assertEqual(product2.list_price_used, Decimal('15'))
