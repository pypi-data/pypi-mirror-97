...
'''
This is basically the test from the stock module, but with patched method
check_origin_type.
'''


def patch_origin_types():
    return set()
...
class SaleAvailableStockTestCase(ModuleTestCase):
    ...
    def test_move_internal_quantity(self):
        ...
        # Avoid the UserWarning for missing origin
        Move.check_origin_types = patch_origin_types
