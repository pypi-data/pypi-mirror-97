...
- disabled (boolean; optional): If `true`, the label should be displayed in a disabled state.
...
- focused (boolean; optional): If `true`, the input of this label is focused (used by `FormGroup` components).
