...
- direction (a value equal to: "left", "right", "up", "down"; optional): Direction the child node will enter from.
...
- style (dict; optional)"""
    @_explicitize_args
    def __init__(self, children=None, appear=Component.UNDEFINED, direction=Component.UNDEFINED, enter=Component.UNDEFINED, exit=Component.UNDEFINED, mountOnEnter=Component.UNDEFINED, unmountOnExit=Component.UNDEFINED, id=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'appear', 'direction', 'in', 'enter', 'exit', 'mountOnEnter', 'unmountOnExit', 'id', 'style']
        self._type = 'Slide'
        self._namespace = 'materialdashboard'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'appear', 'direction', 'in', 'enter', 'exit', 'mountOnEnter', 'unmountOnExit', 'id', 'style']
