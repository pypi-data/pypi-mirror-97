...
class CreateRegressionRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        score_to_optimize = RegressionScorers(d.pop("scoreToOptimize"))
        ...
        create_regression_request.additional_properties = d
        return create_regression_request
