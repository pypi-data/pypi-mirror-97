...
class electricalc_ElectricalCalculator:
    ...
    def registerMyMethods(self):
        ...
        def _hx_local_0(args):
            ...
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.ConvertPhaseAngleToPowerFactor' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ElectricalCalculator.ConvertPhaseAngleToPowerFactor",maglev_MagLevFunction.fromFunction(_hx_local_0))
        def _hx_local_1(args):
            ...
            data.push(maglev_MagLevString.fromString("electricalc"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.ConvertPowerFactorToPhaseAngle' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ElectricalCalculator.ConvertPowerFactorToPhaseAngle",maglev_MagLevFunction.fromFunction(_hx_local_1))
        def _hx_local_2(args):
            ...
            data.push(maglev_MagLevString.fromString("electricalc"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.CalculateSinglePhasePower' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ElectricalCalculator.CalculateSinglePhasePower",maglev_MagLevFunction.fromFunction(_hx_local_2))
        def _hx_local_3(args):
            ...
            data.push(maglev_MagLevString.fromString("electricalc"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.CalculateThreePhasePower' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("ElectricalCalculator.CalculateThreePhasePower",maglev_MagLevFunction.fromFunction(_hx_local_3))
