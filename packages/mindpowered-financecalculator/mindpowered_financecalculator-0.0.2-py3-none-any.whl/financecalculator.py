...
class financecalculator_FinCalc:
    _hx_class_name = "financecalculator.FinCalc"
    __slots__ = ()

    def __init__(self):
        pass

    def futureValue(self,presentValue,numPeriods,interestRate,timesCompoundedPerPeriod,depositAmount,depositAtBeginning):
        ir = (interestRate / 100.0)
        fvps = (presentValue * Math.pow((1 + ir),numPeriods))
        fv = (depositAmount / ir)
        fv = (fv * ((Math.pow((1 + ir),numPeriods) - 1.0)))
        ...
        v = (futureValue * 100.0)
        futureValue = (((v if (((v == Math.POSITIVE_INFINITY) or ((v == Math.NEGATIVE_INFINITY)))) else (Math.NaN if (python_lib_Math.isnan(v)) else Math.floor((v + 0.5))))) / 100.0)
        v = (totalInterest * 100.0)
        totalInterest = (((v if (((v == Math.POSITIVE_INFINITY) or ((v == Math.NEGATIVE_INFINITY)))) else (Math.NaN if (python_lib_Math.isnan(v)) else Math.floor((v + 0.5))))) / 100.0)
        v = (totalDeposits * 100.0)
        totalDeposits = (((v if (((v == Math.POSITIVE_INFINITY) or ((v == Math.NEGATIVE_INFINITY)))) else (Math.NaN if (python_lib_Math.isnan(v)) else Math.floor((v + 0.5))))) / 100.0)
        return _hx_AnonObject({'futureValue': futureValue, 'totalInterest': totalInterest, 'totalDeposits': totalDeposits})
...
class financecalculator_FinanceCalculator:
    _hx_class_name = "financecalculator.FinanceCalculator"
    __slots__ = ("maglev", "calc")

    def __init__(self,maglev):
        self.maglev = maglev
        self.calc = financecalculator_FinCalc()
    ...
    def registerMyMethods(self):
        ...
        def _hx_local_0(args):
            ...
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'FinanceCalculator.PresentValueOfFutureMoney' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("FinanceCalculator.PresentValueOfFutureMoney",maglev_MagLevFunction.fromFunction(_hx_local_0))
        def _hx_local_1(args):
            ...
            data.push(maglev_MagLevString.fromString("financecalculator"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'FinanceCalculator.PresentValueOfDeposits' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("FinanceCalculator.PresentValueOfDeposits",maglev_MagLevFunction.fromFunction(_hx_local_1))
        def _hx_local_14(args):
            def _hx_local_3():
                _hx_local_2 = args.get(0)
                if (Std.isOfType(_hx_local_2,maglev_MagLevNumber) or ((_hx_local_2 is None))):
                    _hx_local_2
                else:
                    raise "Class cast error"
                return _hx_local_2
            presentValue = (_hx_local_3()).getFloat()
            def _hx_local_5():
                _hx_local_4 = args.get(1)
                if (Std.isOfType(_hx_local_4,maglev_MagLevNumber) or ((_hx_local_4 is None))):
                    _hx_local_4
                else:
                    raise "Class cast error"
                return _hx_local_4
            numPeriods = (_hx_local_5()).getInt()
            def _hx_local_7():
                _hx_local_6 = args.get(2)
                if (Std.isOfType(_hx_local_6,maglev_MagLevNumber) or ((_hx_local_6 is None))):
                    _hx_local_6
                else:
                    raise "Class cast error"
                return _hx_local_6
            interestRate = (_hx_local_7()).getFloat()
            def _hx_local_9():
                _hx_local_8 = args.get(3)
                if (Std.isOfType(_hx_local_8,maglev_MagLevNumber) or ((_hx_local_8 is None))):
                    _hx_local_8
                else:
                    raise "Class cast error"
                return _hx_local_8
            timesCompoundedPerPeriod = (_hx_local_9()).getInt()
            def _hx_local_11():
                _hx_local_10 = args.get(4)
                if (Std.isOfType(_hx_local_10,maglev_MagLevNumber) or ((_hx_local_10 is None))):
                    _hx_local_10
                else:
                    raise "Class cast error"
                return _hx_local_10
            depositAmount = (_hx_local_11()).getFloat()
            def _hx_local_13():
                _hx_local_12 = args.get(5)
                if (Std.isOfType(_hx_local_12,maglev_MagLevBoolean) or ((_hx_local_12 is None))):
                    _hx_local_12
                else:
                    raise "Class cast error"
                return _hx_local_12
            depositAtBeginning = (_hx_local_13()).getBool()
            ...
            resobj = maglev_MagLevObject.create()
            ...
            result = maglev_MagLevResult.fromResult(resobj)
            return result
        self.maglev.register("FinanceCalculator.FutureValue",maglev_MagLevFunction.fromFunction(_hx_local_14))
        def _hx_local_15(args):
            ...
            data.push(maglev_MagLevString.fromString("financecalculator"))
            bus.call("MindPowered.Telemetry.Send",data)
            err = maglev_MagLevError.create(-20000,"You are trying to use the 'FinanceCalculator.NetPresentValue' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data)
            result = maglev_MagLevResult.fromError(err)
            return result
        self.maglev.register("FinanceCalculator.NetPresentValue",maglev_MagLevFunction.fromFunction(_hx_local_15))
