...
from sagemaker_training import logging_config, mapping, params # sagemaker specific? Needed?

logger = logging_config.get_logger()

SAGEMAKER_BASE_PATH = os.path.join("/opt", "ml")  # type: str # naming specific to sagemaker?
BASE_PATH_ENV = "SAGEMAKER_BASE_DIR"  # type: str  # naming specific to sagemaker?
