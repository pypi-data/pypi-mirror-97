...
def get_observational_uplift_data_1(num_obs, noise = False):
    """Creates sample uplift dataset with an experiment between different 'models'
    ...
    if noise:
        y = y + np.random.normal(0, .1, num_obs)
...
def get_observational_uplift_data_2(num_obs):
    """Creates sample uplift dataset with 3 variables.
    First two variables are of form y_i = x_i*t + e for two responses
