    ...
    r(A.prototype, {
      ...
      getSVG: function (a) {
        var c,
          ...
          g = p(this.options, a);
        n.createElementNS ||
          (n.createElementNS = function (a, c) {
      ...
      getSVGForExport: function (a, c) {
        ...
        return this.getSVG(
          p({ chart: { borderRadius: 0 } }, e.chartOptions, c, {
            exporting: {
      ...
      contextMenu: function (a, c, e, b, f, m, g) {
        ...
        l ||
          ...
          (y = q("div", { className: "highcharts-menu" }, null, l)),
          v(
            y,
            r(
              {
        ...
        b + m + d.exportMenuHeight > h && "top" !== g.alignOptions.verticalAlign
          ? (c.bottom = h - b - x + "px")
          : (c.top = b + m - x + "px");
        v(l, c);
        d.openMenu = !0;
      ...
      addButton: function (a) {
        ...
        if (!1 !== b.enabled) {
          ...
          b.text && b.symbol
            ? (k.paddingLeft = C(k.paddingLeft, 25))
            : b.text || r(k, { width: b.width, height: b.height, padding: 0 });
          ...
          b.symbol &&
            ((g = e
              .symbol(b.symbol, b.symbolX - h / 2, b.symbolY - h / 2, h, h)
