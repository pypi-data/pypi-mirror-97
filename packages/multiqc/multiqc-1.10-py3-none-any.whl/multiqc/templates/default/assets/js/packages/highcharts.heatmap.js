  ...
  (function (c) {
    ...
    v(l.prototype, {
      ...
      tweenColors: function (a, b, d) {
        var g;
        b.rgba.length && a.rgba.length
          ? ((a = a.rgba),
            (b = b.rgba),
            (g = 1 !== b[3] || 1 !== a[3]),
            (a =
              (g ? "rgba(" : "rgb(") +
              Math.round(b[0] + (a[0] - b[0]) * (1 - d)) +
              "," +
              Math.round(b[1] + (a[1] - b[1]) * (1 - d)) +
              "," +
              Math.round(b[2] + (a[2] - b[2]) * (1 - d)) +
              (g ? "," + (b[3] + (a[3] - b[3]) * (1 - d)) : "") +
              ")"))
          : (a = b.input || "none");
        return a;
      ...
      initDataClasses: function (a) {
        ...
        e(a.dataClasses, function (a, e) {
          ...
          g.push(a);
          a.color ||
            ("category" === y.dataClassColor
              ? ((e = d.options.colors), (c = e.length), (a.color = e[h]), (a.colorIndex = h), h++, h === c && (h = 0))
              : (a.color = b.tweenColors(m(y.minColor), m(y.maxColor), 2 > f ? 0.5 : e / (f - 1))));
        });
      },
      ...
      setAxisSize: function () {
        ...
        a
          ...
          : (this.len = (this.horiz ? d.symbolWidth : d.symbolHeight) || this.defaultLegendLength);
      },
      ...
      drawCrosshair: function (a, b) {
        var d = b && b.plotX,
          ...
          e = this.len;
        b &&
          ((h = this.toPixels(b[b.series.colorKey])),
          h < f ? (h = f - 2) : h > f + e && (h = f + e + 2),
          (b.plotX = h),
          (b.plotY = this.len - h),
          k.prototype.drawCrosshair.call(this, a, b),
          (b.plotX = d),
          (b.plotY = c),
          this.cross &&
      ...
      getPlotLinePath: function (a, b, d, c, h) {
        return w(h)
          ? this.horiz
            ? ["M", h - 4, this.top - 6, "L", h + 4, this.top - 6, h, this.top, "Z"]
            : ["M", this.left, h, "L", this.left - 6, h + 6, this.left - 6, h - 6, "Z"]
          : k.prototype.getPlotLinePath.call(this, a, b, d, c);
      },
      update: function (a, b) {
        var d = this.chart,
          c = d.legend;
      ...
      getDataClassLegendSymbols: function () {
        var a = this,
          ...
          k;
        d.length ||
          e(this.dataClasses, function (g, p) {
            var l = !0,
              q = g.from,
              m = g.to;
            k = "";
    ...
    t(p.prototype, "getAllItems", function (a) {
      ...
      d &&
        d.options &&
        (d.options.showInLegend && (d.options.dataClasses ? (b = b.concat(d.getDataClassLegendSymbols())) : b.push(d)),
    ...
    c.colorSeriesMixin = {
      ...
      translateColors: function () {
        ...
        r(this.data, function (f) {
          var e = f[m];
          if ((e = f.options.color || (f.isNull ? k : l && void 0 !== e ? l.toColor(e, f) : f.color || c.color)))
            f.color = e;
        });
      },
