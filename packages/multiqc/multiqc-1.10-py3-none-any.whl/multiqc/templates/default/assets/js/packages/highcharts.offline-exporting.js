  ...
  (function (a) {
    ...
    a.downloadURL = function (d, a) {
      ...
      if (u.msSaveOrOpenBlob) u.msSaveOrOpenBlob(d, a);
        ...
        (c.href = d), (c.download = a), (c.target = "_blank"), t.body.appendChild(c), c.click(), t.body.removeChild(c);
      else
        try {
    ...
    a.svgToDataUrl = function (d) {
      ...
      try {
        if (!a && 0 > u.userAgent.toLowerCase().indexOf("firefox"))
          return A.createObjectURL(new e.Blob([d], { type: "image/svg+xml;charset-utf-16" }));
      } catch (c) {}
      return "data:image/svg+xml;charset\x3dUTF-8," + encodeURIComponent(d);
    };
    ...
    a.downloadSVGLocal = function (d, f, c, b) {
      ...
      if ("image/svg+xml" === q)
        try {
          u.msSaveOrOpenBlob
            ? ((m = new MSBlobBuilder()), m.append(d), (k = m.getBlob("image/svg+xml")))
            : (k = a.svgToDataUrl(d)),
            a.downloadURL(k, n),
            b && b();
        } catch (x) {
      ...
      try {
        if (l.length)
          for (g = 0, r = l.length; g < r; ++g)
            (h = l[g]),
              a.imageToDataUrl(
                h.getAttributeNS("http://www.w3.org/1999/xlink", "href"),
                "image/png",
                { imageElement: h },
                d.scale,
                q,
    ...
    a.Chart.prototype.exportChartLocal = function (d, e) {
      ...
      ((B && "image/svg+xml" !== b.type) || "application/pdf" === b.type) &&
