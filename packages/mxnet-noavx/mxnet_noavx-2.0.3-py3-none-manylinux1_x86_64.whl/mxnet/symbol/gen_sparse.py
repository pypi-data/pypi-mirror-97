...
def _contrib_round_ste(data=None, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in /root/code/mxnet/src/operator/contrib/stes_op.cc:L55
...
def _contrib_sign_ste(data=None, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in /root/code/mxnet/src/operator/contrib/stes_op.cc:L80
...
def adagrad_update(weight=None, grad=None, history=None, lr=_Null, epsilon=_Null, wd=_Null, rescale_grad=_Null, clip_gradient=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in /root/code/mxnet/src/operator/optimizer_op.cc:L902
...
def retain(data=None, indices=None, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in /root/code/mxnet/src/operator/tensor/sparse_retain.cc:L53
...
__all__ = ['ElementWiseSum', 'Embedding', 'FullyConnected', '_contrib_round_ste', '_contrib_sign_ste', 'abs', 'adagrad_update', 'adam_update', 'add_n', 'arccos', 'arccosh', 'arcsin', 'arcsinh', 'arctan', 'arctanh', 'broadcast_add', 'broadcast_div', 'broadcast_minus', 'broadcast_mul', 'broadcast_plus', 'broadcast_sub', 'cast_storage', 'cbrt', 'ceil', 'clip', 'concat', 'cos', 'cosh', 'degrees', 'digamma', 'dot', 'elemwise_add', 'elemwise_div', 'elemwise_mul', 'elemwise_sub', 'exp', 'expm1', 'fix', 'floor', 'ftrl_update', 'gamma', 'gammaln', 'log', 'log10', 'log1p', 'log2', 'make_loss', 'mean', 'negative', 'norm', 'radians', 'relu', 'retain', 'rint', 'round', 'rsqrt', 'sgd_mom_update', 'sgd_update', 'sigmoid', 'sign', 'sin', 'sinh', 'slice', 'sqrt', 'square', 'stop_gradient', 'sum', 'tan', 'tanh', 'trunc', 'where', 'zeros_like']