...
[boto3.AutoScalingPlans 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/autoscaling-plans.html#AutoScalingPlans) service
compatible with
