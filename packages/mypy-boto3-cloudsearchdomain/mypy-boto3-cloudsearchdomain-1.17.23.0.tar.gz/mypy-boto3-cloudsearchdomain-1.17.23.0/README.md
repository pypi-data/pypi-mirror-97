...
[boto3.CloudSearchDomain 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/cloudsearchdomain.html#CloudSearchDomain) service
compatible with
