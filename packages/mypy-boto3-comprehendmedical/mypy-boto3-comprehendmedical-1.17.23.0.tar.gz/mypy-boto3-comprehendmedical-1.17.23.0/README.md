...
[boto3.ComprehendMedical 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/comprehendmedical.html#ComprehendMedical) service
compatible with
