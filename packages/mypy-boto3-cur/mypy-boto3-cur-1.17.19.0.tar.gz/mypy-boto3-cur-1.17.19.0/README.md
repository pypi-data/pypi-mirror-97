...
[boto3.CostandUsageReportService 1.17.19](https://boto3.amazonaws.com/v1/documentation/api/1.17.19/reference/services/cur.html#CostandUsageReportService) service
compatible with
