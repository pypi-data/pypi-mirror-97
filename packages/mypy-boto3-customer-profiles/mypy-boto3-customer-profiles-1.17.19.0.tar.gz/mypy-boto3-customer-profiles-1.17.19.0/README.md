...
[boto3.CustomerProfiles 1.17.19](https://boto3.amazonaws.com/v1/documentation/api/1.17.19/reference/services/customer-profiles.html#CustomerProfiles) service
compatible with
