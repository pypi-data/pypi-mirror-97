...
[boto3.ApplicationDiscoveryService 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/discovery.html#ApplicationDiscoveryService) service
compatible with
