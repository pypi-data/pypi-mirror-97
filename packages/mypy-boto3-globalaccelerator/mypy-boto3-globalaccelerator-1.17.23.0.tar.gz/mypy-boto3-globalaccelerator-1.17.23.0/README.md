...
[boto3.GlobalAccelerator 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/globalaccelerator.html#GlobalAccelerator) service
compatible with
