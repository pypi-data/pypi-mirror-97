...
[boto3.IoT1ClickDevicesService 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/iot1click-devices.html#IoT1ClickDevicesService) service
compatible with
