...
[boto3.LexModelBuildingService 1.17.22](https://boto3.amazonaws.com/v1/documentation/api/1.17.22/reference/services/lex-models.html#LexModelBuildingService) service
compatible with
