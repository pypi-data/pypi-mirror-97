...
[boto3.LexModelBuildingService 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/lex-models.html#LexModelBuildingService) service
compatible with
