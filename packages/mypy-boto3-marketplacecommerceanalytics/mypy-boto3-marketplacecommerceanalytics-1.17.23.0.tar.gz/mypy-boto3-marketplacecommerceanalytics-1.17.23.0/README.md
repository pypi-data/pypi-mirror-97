...
[boto3.MarketplaceCommerceAnalytics 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/marketplacecommerceanalytics.html#MarketplaceCommerceAnalytics) service
compatible with
