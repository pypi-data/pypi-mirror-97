...
[boto3.PersonalizeRuntime 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/personalize-runtime.html#PersonalizeRuntime) service
compatible with
