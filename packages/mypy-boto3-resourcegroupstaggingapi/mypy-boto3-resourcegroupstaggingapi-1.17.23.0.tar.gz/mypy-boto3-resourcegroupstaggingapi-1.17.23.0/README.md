...
[boto3.ResourceGroupsTaggingAPI 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/resourcegroupstaggingapi.html#ResourceGroupsTaggingAPI) service
compatible with
