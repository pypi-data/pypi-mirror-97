...
[boto3.WorkMailMessageFlow 1.17.23](https://boto3.amazonaws.com/v1/documentation/api/1.17.23/reference/services/workmailmessageflow.html#WorkMailMessageFlow) service
compatible with
