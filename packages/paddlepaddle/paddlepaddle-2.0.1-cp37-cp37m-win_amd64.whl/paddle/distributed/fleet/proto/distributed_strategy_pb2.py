...
_SHARDINGCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='fuse_broadcast_MB', full_name='paddle.fleet.ShardingConfig.fuse_broadcast_MB', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hybrid_dp', full_name='paddle.fleet.ShardingConfig.hybrid_dp', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sharding_group_size', full_name='paddle.fleet.ShardingConfig.sharding_group_size', index=2,
...
_PIPELINECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='micro_batch', full_name='paddle.fleet.PipelineConfig.micro_batch', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DISTRIBUTEDSTRATEGY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='recompute_configs', full_name='paddle.fleet.DistributedStrategy.recompute_configs', index=27,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='amp_configs', full_name='paddle.fleet.DistributedStrategy.amp_configs', index=28,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='localsgd_configs', full_name='paddle.fleet.DistributedStrategy.localsgd_configs', index=29,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gradient_merge_configs', full_name='paddle.fleet.DistributedStrategy.gradient_merge_configs', index=30,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dgc_configs', full_name='paddle.fleet.DistributedStrategy.dgc_configs', index=31,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pipeline_configs', full_name='paddle.fleet.DistributedStrategy.pipeline_configs', index=32,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='a_sync_configs', full_name='paddle.fleet.DistributedStrategy.a_sync_configs', index=33,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lars_configs', full_name='paddle.fleet.DistributedStrategy.lars_configs', index=34,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lamb_configs', full_name='paddle.fleet.DistributedStrategy.lamb_configs', index=35,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='adaptive_localsgd_configs', full_name='paddle.fleet.DistributedStrategy.adaptive_localsgd_configs', index=36,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sharding_configs', full_name='paddle.fleet.DistributedStrategy.sharding_configs', index=37,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='build_strategy', full_name='paddle.fleet.DistributedStrategy.build_strategy', index=38,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='execution_strategy', full_name='paddle.fleet.DistributedStrategy.execution_strategy', index=39,
