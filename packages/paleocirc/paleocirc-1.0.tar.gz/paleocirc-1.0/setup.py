...
setup(
    name='paleocirc',
    packages=find_packages(include=['circolari', 'circolariasync']),
    url='https://github.com/xFranciB/paleocirc',
    download_url='https://github.com/xFranciB/paleocirc/archive/v1.0.tar.gz',
    version='v1.0',
...
""",
    ...
    install_requires=['requests', 'aiohttp', 'asyncio', 'beautifulsoup4', 'pdf2image', 'os', 'json'],
)