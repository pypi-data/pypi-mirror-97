...
from pds_api_client.models.collections import Collections  # noqa: E501
...
class TestCollections(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pds_api_client.models.collections.Collections()  # noqa: E501
        if include_optional :
            return Collections(
                ...
                data = [
                    pds_api_client.models.collection.collection(
                        id = '0', 
                        title = '0', 
                        description = '0', 
                        instruments = [
