...
from pds_api_client.models.products import Products  # noqa: E501
...
class TestProducts(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pds_api_client.models.products.Products()  # noqa: E501
        if include_optional :
            return Products(
                summary = pds_api_client.models.summary.summary(
                    q = '0', 
                    start = 56, 
                    limit = 56, 
                    sort = [
                ...
                data = [
                    pds_api_client.models.product.product(
                        id = '0', 
                        type = '0', 
                        title = '0', 
                        description = '0', 
