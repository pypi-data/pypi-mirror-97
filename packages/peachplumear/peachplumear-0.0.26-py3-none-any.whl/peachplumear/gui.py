...
if __package__ == '':
    import challenge
    from mingus.containers import Track,NoteContainer,Note
    import mingus.core.progressions as progressions
    import mingus.midi.fluidsynth as fluidsynth
else:
...
imPath = os.path.join(os.path.dirname(__file__), 'Images')
homeSF2 = os.path.join(os.path.dirname(__file__), 'Yamaha-Grand-Lite-v2.0.sf2')

class GUI():
    def __init__(self,root,sf2=homeSF2):
        # given parameters
        self.root = root
        ...
        self.root.iconbitmap(os.path.join(imPath,'icon.ico'))
        self.root.configure(background='white')

        # images for buttons
        self.keyLockIm = PhotoImage(file=os.path.join(imPath,'keyLock.png'))
        self.newIm = PhotoImage(file=os.path.join(imPath,'New.png'))
        self.playIm = PhotoImage(file=os.path.join(imPath,'PlayB.png'))
        self.playChIm = PhotoImage(file=os.path.join(imPath,'PlayChB.png'))
        self.revealIm = PhotoImage(file=os.path.join(imPath,'RevealB.png'))
        self.BPMupIm = PhotoImage(file=os.path.join(imPath,'BPMupB.png'))
        self.BPMdownIm = PhotoImage(file=os.path.join(imPath,'BPMdownB.png'))
        self.majIm = PhotoImage(file=os.path.join(imPath,'maj.png'))
        self.minIm = PhotoImage(file=os.path.join(imPath,'min.png'))
        self.playIntIm = PhotoImage(file=os.path.join(imPath,'playInt.png'))
        self.I_Im = PhotoImage(file=os.path.join(imPath,'I.png'))
        self.II_Im = PhotoImage(file=os.path.join(imPath,'II.png'))
        self.III_Im = PhotoImage(file=os.path.join(imPath,'III.png'))
        self.IV_Im = PhotoImage(file=os.path.join(imPath,'IV.png'))
        self.V_Im = PhotoImage(file=os.path.join(imPath,'V.png'))
        self.VI_Im = PhotoImage(file=os.path.join(imPath,'VI.png'))
        self.VII_Im = PhotoImage(file=os.path.join(imPath,'VII.png'))
        self.inv_Im = PhotoImage(file=os.path.join(imPath,'inv.png'))
        self.oct_Im = PhotoImage(file=os.path.join(imPath,'8ave.png'))
        self.scaleIm = PhotoImage(file=os.path.join(imPath,'scale.png'))
        self.chordIm = PhotoImage(file=os.path.join(imPath,'chord.png'))
        ...
        self.BPMIm = PhotoImage(file=os.path.join(imPath,'BPM.png'))
        ...
        self.NintIm = PhotoImage(file=os.path.join(imPath,'Nint.png'))
