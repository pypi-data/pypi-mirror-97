...
from peachplumear.mingus.containers.note import Note
from peachplumear.mingus.containers.note_container import NoteContainer
from peachplumear.mingus.containers.bar import Bar
from peachplumear.mingus.containers.track import Track
from peachplumear.mingus.containers.composition import Composition
from peachplumear.mingus.containers.instrument import MidiInstrument
import peachplumear.mingus.core.notes as notes
import peachplumear.mingus.core.intervals as intervals
import binascii
...
class MidiFile(object):
    ...
    def parse_midi_event(self, fp):
        ...
        if event_type == 0x0F:
            ...
            return (
                {"event": event_type, "meta_event": meta_event, "data": data},
                chunk_size,
            )
            ...
            return (
                {"event": event_type, "channel": channel, "param1": param1},
                chunk_size,
            )
        else:
            try:
