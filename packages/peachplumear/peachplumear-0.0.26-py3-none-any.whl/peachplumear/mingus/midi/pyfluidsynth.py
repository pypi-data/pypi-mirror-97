...
par = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
if platform.system()=='Windows':
    lib = os.path.join(par,'Fluidsynth','win','libfluidsynth-2.dll')
elif platform.system()=='Darwin':
    lib = os.path.join(par,'Fluidsynth','osx','fluidsynth')
if lib is None:
