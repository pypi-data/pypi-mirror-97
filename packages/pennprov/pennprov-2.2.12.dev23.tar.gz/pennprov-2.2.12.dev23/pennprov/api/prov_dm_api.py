...
class ProvDmApi(object):
    ...
    def store_prov_dm_subgraph(self, resource, body, **kwargs):  # noqa: E501
        """Store a PROV DM subgraph  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_prov_dm_subgraph(resource, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str resource: (required)
        :param ProvDmSubgraph body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.store_prov_dm_subgraph_with_http_info(resource, body, **kwargs)  # noqa: E501
        else:
            (data) = self.store_prov_dm_subgraph_with_http_info(resource, body, **kwargs)  # noqa: E501
            return data

    def store_prov_dm_subgraph_with_http_info(self, resource, body, **kwargs):  # noqa: E501
        """Store a PROV DM subgraph  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_prov_dm_subgraph_with_http_info(resource, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method store_prov_dm_subgraph" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'resource' is set
        if ('resource' not in params or
                params['resource'] is None):
            raise ValueError("Missing the required parameter `resource` when calling `store_prov_dm_subgraph`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `store_prov_dm_subgraph`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/provdm/graphs/{resource}/subgraphs', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
