...
PETSC_EXTERN void  petscdsdestroy_(PetscDS *prob, int *__ierr)
{
*__ierr = PetscDSDestroy(prob);
}
PETSC_EXTERN void  petscdscreate_(MPI_Fint * comm,PetscDS *prob, int *__ierr)
{
...
PETSC_EXTERN void  petscdshasbdjacobian_(PetscDS prob,PetscBool *hasBdJac, int *__ierr)
{
*__ierr = PetscDSHasBdJacobian(
	(PetscDS)PetscToPointer((prob) ),hasBdJac);
}
PETSC_EXTERN void  petscdshasbdjacobianpreconditioner_(PetscDS prob,PetscBool *hasBdJacPre, int *__ierr)
{
*__ierr = PetscDSHasBdJacobianPreconditioner(
	(PetscDS)PetscToPointer((prob) ),hasBdJacPre);
}
...
PETSC_EXTERN void  petscdscopyboundary_(PetscDS probA,PetscDS probB, int *__ierr)
{
