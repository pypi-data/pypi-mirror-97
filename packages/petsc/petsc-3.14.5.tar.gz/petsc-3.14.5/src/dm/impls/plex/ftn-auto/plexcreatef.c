...
extern "C" {
#endif
PETSC_EXTERN void  dmplexcreatedoublet_(MPI_Fint * comm,PetscInt *dim,PetscBool *simplex,PetscBool *interpolate,PetscBool *refinementUniform,PetscReal *refinementLimit,DM *newdm, int *__ierr)
{
