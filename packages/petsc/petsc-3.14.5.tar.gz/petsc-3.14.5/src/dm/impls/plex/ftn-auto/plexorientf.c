...
extern "C" {
#endif
PETSC_EXTERN void  dmplexcompareorientations_(DM dm,PetscInt *p,PetscInt *masterConeSize, PetscInt masterCone[],PetscInt *start,PetscBool *reverse, int *__ierr)
{
*__ierr = DMPlexCompareOrientations(
	(DM)PetscToPointer((dm) ),*p,*masterConeSize,masterCone,start,reverse);
}
PETSC_EXTERN void  dmplexorientcell_(DM dm,PetscInt *p,PetscInt *masterConeSize, PetscInt masterCone[], int *__ierr)
{
*__ierr = DMPlexOrientCell(
	(DM)PetscToPointer((dm) ),*p,*masterConeSize,masterCone);
}
