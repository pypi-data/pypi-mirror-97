...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define kspsetmatsolveblocksize_ KSPSETMATSOLVEBLOCKSIZE
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define kspsetmatsolveblocksize_ kspsetmatsolveblocksize
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define kspgetmatsolveblocksize_ KSPGETMATSOLVEBLOCKSIZE
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define kspgetmatsolveblocksize_ kspgetmatsolveblocksize
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void  kspsetmatsolveblocksize_(KSP ksp,PetscInt *bs, int *__ierr)
{
*__ierr = KSPSetMatSolveBlockSize(
	(KSP)PetscToPointer((ksp) ),*bs);
}
PETSC_EXTERN void  kspgetmatsolveblocksize_(KSP ksp,PetscInt *bs, int *__ierr)
{
*__ierr = KSPGetMatSolveBlockSize(
	(KSP)PetscToPointer((ksp) ),bs);
}
...
PETSC_EXTERN void  kspdestroy_(KSP *ksp, int *__ierr)
{
