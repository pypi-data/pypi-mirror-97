...
extern "C" {
#endif
PETSC_EXTERN void  vecscattergetmerged_(VecScatter ctx,PetscBool  *flg, int *__ierr)
{
*__ierr = VecScatterGetMerged(
	(VecScatter)PetscToPointer((ctx) ),flg);
}
PETSC_EXTERN void  vecscatterbegin_(VecScatter ctx,Vec x,Vec y,InsertMode *addv,ScatterMode *mode, int *__ierr)
{
...
PETSC_EXTERN void  vecscatterend_(VecScatter ctx,Vec x,Vec y,InsertMode *addv,ScatterMode *mode, int *__ierr)
{
...
PETSC_EXTERN void  vecscatterdestroy_(VecScatter *ctx, int *__ierr)
{
*__ierr = VecScatterDestroy(ctx);
}
PETSC_EXTERN void  vecscattersetup_(VecScatter ctx, int *__ierr)
{
*__ierr = VecScatterSetUp(
	(VecScatter)PetscToPointer((ctx) ));
}
PETSC_EXTERN void  vecscattercopy_(VecScatter sctx,VecScatter *ctx, int *__ierr)
{
