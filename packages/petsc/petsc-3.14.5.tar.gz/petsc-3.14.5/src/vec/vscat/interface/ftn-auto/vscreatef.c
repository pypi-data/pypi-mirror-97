...
extern "C" {
#endif
PETSC_EXTERN void  vecscattersetfromoptions_(VecScatter vscat, int *__ierr)
{
*__ierr = VecScatterSetFromOptions(
	(VecScatter)PetscToPointer((vscat) ));
}
PETSC_EXTERN void  vecscattercreate_(Vec xin,IS ix,Vec yin,IS iy,VecScatter *newctx, int *__ierr)
{
