...
def checkdeep(tree_file, model=BD, png_outputfile='a_priori_check.png', **kvargs):
    ...
    pca_plot(pca_encoded_tree, pca_data, loaded_pca.explained_variance_ratio, png_outputfile)
...
def main():
    ...
    output_group.add_argument('-p', '--png_outputfile', required=True, type=str, help="The name of png output file.")
