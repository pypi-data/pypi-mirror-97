...
def get_artifacts_path(rel_path: str = None, ensure_path: bool = False, is_dir: bool = False):
    global TRACKING_RUN
...
def get_outputs_path(rel_path: str = None, ensure_path: bool = True, is_dir: bool = False):
    global TRACKING_RUN
...
def log_sklearn_pr_curve(
    name: str, y_preds, y_targets, step: int = None, timestamp: datetime = None,  is_multi_class: bool = False,
):
    global TRACKING_RUN
