...
sequence.
"""
from procuret.tests.test_result import TestResult, Failure
...
class Test:
    ...
    def __init__(self) -> None:
        ...
        self._user_id = arguments.require(
            key='--user-id',
            of_type=int,
            type_name='integer'
        )

        self._secret = arguments.require(
            key='--secret',
            of_type=str,
            type_name='string'
        )

        self._email = arguments.require(
            key='--email',
            of_type=str,
            type_name='string'
        )
    ...
    secret = property(lambda s: s._secret)
