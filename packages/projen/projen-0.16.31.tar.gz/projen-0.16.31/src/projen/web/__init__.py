...
class NextJsProject(
    ...
    def __init__(
        ...
        *,
        ...
        rebuild_bot: typing.Optional[builtins.bool] = None,
        rebuild_bot_command: typing.Optional[builtins.str] = None,
        ...
        :param rebuild_bot: (experimental) Installs a GitHub workflow which is triggered when the comment "@projen rebuild" is added to a pull request. The workflow will run a full build and commit the changes to the pull request branch. This is useful for updating test snapshots and other generated files like API.md. Default: - true if not a subproject
        :param rebuild_bot_command: (experimental) The pull request bot command to use in order to trigger a rebuild and commit of the contents of the branch. The command must be prefixed by "@projen", e.g. "@projen rebuild" ``gh pr review $pr --comment -b "@projen rebuild"`` Default: "rebuild"
        ...
        options = NextJsProjectOptions(
            ...
            rebuild_bot=rebuild_bot,
            rebuild_bot_command=rebuild_bot_command,
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "rebuild_bot": "rebuildBot",
        "rebuild_bot_command": "rebuildBotCommand",
...
class NextJsProjectOptions(NextJsCommonProjectOptions, _NodeProjectOptions_0a6b3d0f):
    def __init__(
        ...
        *,
        ...
        if rebuild_bot is not None:
            self._values["rebuild_bot"] = rebuild_bot
        if rebuild_bot_command is not None:
            self._values["rebuild_bot_command"] = rebuild_bot_command
    ...
    @builtins.property
    def rebuild_bot(self) -> typing.Optional[builtins.bool]:
        ...
        :stability: experimental
        '''
        result = self._values.get("rebuild_bot")
        return typing.cast(typing.Optional[builtins.bool], result)

    @builtins.property
    def rebuild_bot_command(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        '''
        result = self._values.get("rebuild_bot_command")
        return typing.cast(typing.Optional[builtins.str], result)
