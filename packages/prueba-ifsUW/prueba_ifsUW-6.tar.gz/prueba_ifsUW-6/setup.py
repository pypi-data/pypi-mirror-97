...
setup(
    ...
    install_requires= ['matplotlib>=3.2.2,<4.0.0','numpy >=1.18.5,<1.2.0','astropy>=4.0.1,<5.0.0','opencv-python >=4.4.0.46,<4.5.0.0','scikit-image>=0.16.2,<1.0.0.','scipy>=1.5.0,<2.0.0','Pillow >=7.2.0,<8.2.0'],
    version='6',
