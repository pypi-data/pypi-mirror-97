"""
Python setup file for the psu-infotext app.
...
psu_infotext/__init__.py and re-run the above command.
...
setup(
    ...
    license='MIT License',
    description='Editable text for PSU Django apps',
