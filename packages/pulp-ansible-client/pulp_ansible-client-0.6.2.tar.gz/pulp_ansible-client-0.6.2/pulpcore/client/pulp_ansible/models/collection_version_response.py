...
class CollectionVersionResponse(object):
    ...
    def __init__(self, version=None, href=None, created_at=None, updated_at=None, artifact=None, collection=None, download_url=None, name=None, namespace=None, metadata=None, local_vars_configuration=None):  # noqa: E501
