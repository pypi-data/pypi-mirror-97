...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, name=None, content_guard=None, pulp_labels=None, repository=None, base_path=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
