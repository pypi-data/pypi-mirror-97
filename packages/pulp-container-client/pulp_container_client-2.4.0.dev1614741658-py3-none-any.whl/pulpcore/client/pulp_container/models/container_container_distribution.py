...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository_version=None, name=None, pulp_labels=None, repository=None, content_guard=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
