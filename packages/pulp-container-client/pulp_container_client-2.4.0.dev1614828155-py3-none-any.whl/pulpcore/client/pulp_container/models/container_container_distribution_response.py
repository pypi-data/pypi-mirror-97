...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, name=None, content_guard=None, pulp_labels=None, pulp_href=None, repository=None, base_path=None, pulp_created=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
