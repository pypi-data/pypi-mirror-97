...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, pulp_labels=None, content_guard=None, repository=None, base_path=None, repository_version=None, name=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
