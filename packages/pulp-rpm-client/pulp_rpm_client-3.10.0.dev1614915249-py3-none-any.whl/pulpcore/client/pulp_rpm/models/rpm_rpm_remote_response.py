...
class RpmRpmRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, name=None, url=None, ca_cert=None, client_cert=None, tls_validation=None, proxy_url=None, pulp_labels=None, pulp_last_updated=None, download_concurrency=None, policy=None, total_timeout=None, connect_timeout=None, sock_connect_timeout=None, sock_read_timeout=None, rate_limit=None, sles_auth_token=None, local_vars_configuration=None):  # noqa: E501
