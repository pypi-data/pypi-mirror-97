...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.5.0-alpha.1615318135+943c4ee7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.5.0-alpha.1615318135+943c4ee7`
                """)
            else:
                raise
