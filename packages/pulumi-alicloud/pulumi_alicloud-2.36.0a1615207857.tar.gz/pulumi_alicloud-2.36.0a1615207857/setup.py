...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.36.0-alpha.1615207857+a803dcb1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.36.0-alpha.1615207857+a803dcb1`
                """)
            else:
                raise
