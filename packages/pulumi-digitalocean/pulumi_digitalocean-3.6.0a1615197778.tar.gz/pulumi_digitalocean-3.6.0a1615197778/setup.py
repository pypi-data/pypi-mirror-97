...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.6.0-alpha.1615197778+ef471b2c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.6.0-alpha.1615197778+ef471b2c`
                """)
            else:
                raise
