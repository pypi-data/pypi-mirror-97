...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.6.0-alpha.1615197936+2ed2b717'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.6.0-alpha.1615197936+2ed2b717`
                """)
            else:
                raise
