...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.12.0-alpha.1615322059+d62f301b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.12.0-alpha.1615322059+d62f301b`
                """)
            else:
                raise
