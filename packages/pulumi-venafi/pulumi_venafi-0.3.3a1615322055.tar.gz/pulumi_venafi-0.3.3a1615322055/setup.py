...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '0.3.3-alpha.1615322055+c5dfc264'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 0.3.3-alpha.1615322055+c5dfc264`
                """)
            else:
                raise
