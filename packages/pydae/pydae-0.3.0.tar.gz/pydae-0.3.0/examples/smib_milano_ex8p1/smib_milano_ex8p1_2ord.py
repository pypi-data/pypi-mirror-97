...
class smib_milano_ex8p1_2ord_class: 
    ...
    def __init__(self): 
        ...
        self.N_z = 1 
        self.N_store = 10000 
        self.params_list = ['X_d', 'X1d', 'R_a', 'H', 'D', 'Omega_b', 'omega_s', 'X_g', 'v_0', 'theta_0'] 
        self.params_values_list  = [1.81, 0.3, 0.003, 3.5, 1.0, 314.1592653589793, 1.0, 0.05, 1.0, 0.0] 
        self.inputs_ini_list = ['P', 'Q'] 
        ...
        self.y_list = ['p_e', 'i_d', 'i_q', 'v_d', 'v_q', 'P', 'Q', 'v_1', 'theta_1'] 
        self.xy_list = self.x_list + self.y_list 
        self.y_ini_list = ['p_e', 'i_d', 'i_q', 'v_d', 'v_q', 'p_m', 'e1q', 'v_1', 'theta_1'] 
...
def run(t,struct,mode):
    ...
    if mode == 3:
        ...
        struct[0].g[1,0] = R_a*i_q + X1d*i_d - e1q + v_q
        struct[0].g[2,0] = R_a*i_d - X1d*i_q + v_d
        struct[0].g[3,0] = v_1*sin(delta - theta_1) - v_d
        struct[0].g[4,0] = v_1*cos(delta - theta_1) - v_q
        struct[0].g[5,0] = -P + i_d*v_d + i_q*v_q
        struct[0].g[6,0] = -Q + i_d*v_q - i_q*v_d
        struct[0].g[7,0] = P + v_0*v_1*sin(theta_0 - theta_1)/X_g
        struct[0].g[8,0] = Q + v_0*v_1*cos(theta_0 - theta_1)/X_g - v_1**2/X_g
    ...
    if mode == 11:
        ...
        struct[0].Gy[2,3] = 1
        struct[0].Gy[3,3] = -1
        struct[0].Gy[3,7] = sin(delta - theta_1)
        struct[0].Gy[3,8] = -v_1*cos(delta - theta_1)
        struct[0].Gy[4,4] = -1
        struct[0].Gy[4,7] = cos(delta - theta_1)
        struct[0].Gy[4,8] = v_1*sin(delta - theta_1)
        struct[0].Gy[5,1] = v_d
        struct[0].Gy[5,2] = v_q
        struct[0].Gy[5,3] = i_d
        struct[0].Gy[5,4] = i_q
        ...
        struct[0].Gy[6,6] = -1
        struct[0].Gy[7,5] = 1
        struct[0].Gy[7,7] = v_0*sin(theta_0 - theta_1)/X_g
        struct[0].Gy[7,8] = -v_0*v_1*cos(theta_0 - theta_1)/X_g
        struct[0].Gy[8,6] = 1
        struct[0].Gy[8,7] = v_0*cos(theta_0 - theta_1)/X_g - 2*v_1/X_g
        struct[0].Gy[8,8] = v_0*v_1*sin(theta_0 - theta_1)/X_g
...
def ini(struct,mode):
    ...
    e1q = struct[0].y_ini[6,0]
    v_1 = struct[0].y_ini[7,0]
    theta_1 = struct[0].y_ini[8,0]
    ...
    if mode == 3:
        ...
        struct[0].g_ini[2,0] = R_a*i_d - X1d*i_q + v_d
        struct[0].g_ini[3,0] = v_1*sin(delta - theta_1) - v_d
        struct[0].g_ini[4,0] = v_1*cos(delta - theta_1) - v_q
        struct[0].g_ini[5,0] = -P + i_d*v_d + i_q*v_q
        struct[0].g_ini[6,0] = -Q + i_d*v_q - i_q*v_d
        struct[0].g_ini[7,0] = P + v_0*v_1*sin(theta_0 - theta_1)/X_g
        struct[0].g_ini[8,0] = Q + v_0*v_1*cos(theta_0 - theta_1)/X_g - v_1**2/X_g
    ...
    if mode == 11:
        ...
        struct[0].Gy_ini[1,6] = -1
        struct[0].Gy_ini[2,1] = R_a
        struct[0].Gy_ini[2,2] = -X1d
        struct[0].Gy_ini[2,3] = 1
        struct[0].Gy_ini[3,3] = -1
        struct[0].Gy_ini[3,7] = sin(delta - theta_1)
        struct[0].Gy_ini[3,8] = -v_1*cos(delta - theta_1)
        struct[0].Gy_ini[4,4] = -1
        struct[0].Gy_ini[4,7] = cos(delta - theta_1)
        struct[0].Gy_ini[4,8] = v_1*sin(delta - theta_1)
        ...
        struct[0].Gy_ini[7,7] = v_0*sin(theta_0 - theta_1)/X_g
        struct[0].Gy_ini[7,8] = -v_0*v_1*cos(theta_0 - theta_1)/X_g
        struct[0].Gy_ini[8,7] = v_0*cos(theta_0 - theta_1)/X_g - 2*v_1/X_g
        struct[0].Gy_ini[8,8] = v_0*v_1*sin(theta_0 - theta_1)/X_g
