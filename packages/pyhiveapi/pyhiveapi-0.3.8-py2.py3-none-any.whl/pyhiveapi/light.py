...
class Light:
    ...
    def getMinColorTemp(self, device):
    ...
    def getMaxColorTemp(self, device):
    ...
    def turnOn(self, device, brightness, color_temp, color):
    ...
    def setBrightness(self, device, n_brightness):
    ...
    def setColorTemp(self, device, color_temp):
        """Set light to turn on."""
        final = False
    ...
    def setColor(self, device, new_color):
        """Set light to turn on."""
        final = False
