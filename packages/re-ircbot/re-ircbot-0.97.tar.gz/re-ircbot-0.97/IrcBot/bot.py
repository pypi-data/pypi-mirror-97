...
class IrcBot(object):
    ...
    async def connect(self):
        ...
        async with s:
            ...
            async with trio.open_nursery() as nursery:
                ...
                nursery.start_soon(self._message_task_loop)
                nursery.start_soon(self._db_operation_loop)
    ...
    async def _message_task_loop(self):
    ...
    async def _db_operation_loop(self):
