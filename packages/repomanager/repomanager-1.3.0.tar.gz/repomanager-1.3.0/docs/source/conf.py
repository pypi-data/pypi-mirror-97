...
#!/usr/bin/env python
#
# repomanager documentation build configuration file, created by
...
release = repomanager.__version__
...
htmlhelp_basename = 'repomanagerdoc'
