    ...
    def _(event):
        ...
        if not (single_line and token_exists(current_line.strip())):
            ...
            if (not single_line or keyword in single_line_enabled_keywords) and keyword in enter_completable_keywords:
                ...
                refresh_strings_from_buffer()
                indent=current_line
                # assert not current_line.strip() Got rid of this because it crashed RP. But the assertion shud prob still be thought about when writing code here so il leave it anyway...
