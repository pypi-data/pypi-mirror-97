...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.path_open.clicked.connect(self.path_open.animateClick)
        self.actionExit.triggered.connect(self.actionExit.toggle)
        self.actionOpen.triggered.connect(self.actionOpen.toggle)
