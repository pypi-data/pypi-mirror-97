...
class ResponseServiceTemplate(object):
    ...
    openapi_types = {
        ...
        'field_properties': 'list[ModelFieldProperty]',
        'id': 'int',
    ...
    def __init__(self, created_by_id=None, created_dt=None, description=None, env_vars=None, field_properties=None, id=None, image_execute_type=None, is_public=None, is_savvihub_managed=None, kernel_image=None, kernel_image_id=None, kernel_resource_spec_id=None, name=None, ports=None, service_config=None, service_type=None, start_command=None, updated_dt=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def field_properties(self):
        """Gets the field_properties of this ResponseServiceTemplate.  # noqa: E501


        :return: The field_properties of this ResponseServiceTemplate.  # noqa: E501
        :rtype: list[ModelFieldProperty]
        """
        return self._field_properties

    @field_properties.setter
    def field_properties(self, field_properties):
        """Sets the field_properties of this ResponseServiceTemplate.


        :param field_properties: The field_properties of this ResponseServiceTemplate.  # noqa: E501
        :type field_properties: list[ModelFieldProperty]
        """
        if self.local_vars_configuration.client_side_validation and field_properties is None:  # noqa: E501
            raise ValueError("Invalid value for `field_properties`, must not be `None`")  # noqa: E501
    ...
    def kernel_image(self):
        """Gets the kernel_image of this ResponseServiceTemplate.  # noqa: E501


        :return: The kernel_image of this ResponseServiceTemplate.  # noqa: E501
    ...
    def kernel_image(self, kernel_image):
        """Sets the kernel_image of this ResponseServiceTemplate.


        :param kernel_image: The kernel_image of this ResponseServiceTemplate.  # noqa: E501
