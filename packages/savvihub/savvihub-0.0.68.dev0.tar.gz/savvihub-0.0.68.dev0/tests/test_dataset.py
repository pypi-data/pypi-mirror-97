...
from savvihub.common.constants import WEB_HOST, PROJECT_ROOT
...
class DatasetTest(BaseTestCase):
    def test_dataset(self):
        ...
        result = self.runner.invoke(['dataset', 'create', f'aa://{self.workspace_name}/{dataset1_name}/'], allow_fail=True)
        ...
        result = self.runner.invoke(['dataset', 'create', f'svds://{self.workspace_name}/{dataset1_name}/'])
