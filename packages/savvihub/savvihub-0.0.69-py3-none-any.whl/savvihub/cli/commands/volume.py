...
from savvihub_client import ResponseVolume
...
def rm(
    ...
    volume_id, snapshot, path = parse_remote_volume_path(source_path)
    volume_file_remove(ctx, volume_id, snapshot, path, recursive)
...
def volume_file_remove(ctx: Context, volume_id: int, snapshot: str, path: str, recursive: bool):
