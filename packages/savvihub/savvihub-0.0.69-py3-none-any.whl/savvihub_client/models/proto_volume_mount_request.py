...
class ProtoVolumeMountRequest(object):
    ...
    def __init__(self, dataset=None, empty_dir=None, mount_path=None, mount_type=None, output=None, project=None, snapshot=None, volume=None, local_vars_configuration=None):  # noqa: E501
    ...
    def mount_type(self, mount_type):
        ...
        allowed_values = ["empty-dir", "project", "dataset", "output", "volume", "snapshot"]  # noqa: E501
