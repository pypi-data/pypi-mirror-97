...
from savvihub_client import ResponseExperiment


class Experiment(ResponseExperiment):
    def __init__(self, experiment: ResponseExperiment, client):
        super().__init__(experiment.to_dict())
        self.client = client
        self._history = None
