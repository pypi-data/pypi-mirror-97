...
class ModelStorage(object):
    ...
    def __init__(self, base_path=None, bucket_name=None, capacity_limit=None, created_dt=None, credentials=None, edges=None, id=None, minio_endpoint=None, name=None, nfs_host=None, region=None, source_type=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
