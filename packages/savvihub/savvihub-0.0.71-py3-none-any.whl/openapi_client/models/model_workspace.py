...
class ModelWorkspace(object):
    ...
    def __init__(self, aws_external_id=None, created_dt=None, default_region=None, description=None, display_name=None, edges=None, id=None, is_public=None, name=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
