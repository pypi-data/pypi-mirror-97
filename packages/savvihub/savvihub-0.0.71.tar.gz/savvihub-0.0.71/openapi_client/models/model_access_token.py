...
class ModelAccessToken(object):
    ...
    def __init__(self, created_dt=None, edges=None, expire_at=None, id=None, permissions=None, title=None, type=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
