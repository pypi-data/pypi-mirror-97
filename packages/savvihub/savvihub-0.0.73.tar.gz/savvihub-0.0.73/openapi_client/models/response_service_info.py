...
class ResponseServiceInfo(object):
    ...
    def __init__(self, access_token_id=None, created_by=None, created_by_id=None, created_dt=None, dataset_id=None, endpoints=None, env_vars=None, experiment_id=None, expose_type=None, id=None, kernel_cluster=None, kernel_cluster_id=None, kernel_cluster_node=None, kernel_cluster_node_id=None, kernel_cluster_select_policies=None, kernel_image=None, kernel_image_id=None, kernel_resource_spec_id=None, name=None, ports=None, project=None, project_id=None, resource_spec=None, service_config=None, slug=None, start_command=None, status=None, status_last_updated=None, template=None, template_id=None, type=None, updated_dt=None, volume_mounts=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
