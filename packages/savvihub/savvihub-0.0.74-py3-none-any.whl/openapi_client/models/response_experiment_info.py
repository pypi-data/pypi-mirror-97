...
class ResponseExperimentInfo(object):
    ...
    def __init__(self, access_token_id=None, config_id=None, created_by=None, created_by_id=None, created_dt=None, env_vars=None, git_diff_file=None, git_ref=None, histories=None, id=None, kernel_cluster=None, kernel_cluster_id=None, kernel_cluster_node=None, kernel_cluster_node_id=None, kernel_cluster_select_policies=None, kernel_image=None, kernel_image_id=None, kernel_resource_spec=None, kernel_resource_spec_id=None, message=None, metrics_summary=None, name=None, number=None, project=None, project_id=None, reproduce_command=None, slug=None, source_code_link=None, start_command=None, status=None, tensorboard=None, updated_dt=None, volume_mounts=None, workspace=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
