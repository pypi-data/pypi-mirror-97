...
class ResponseKernelClusterNodeInfo(object):
    ...
    openapi_types = {
        ...
        'gpu': 'ResponseKernelClusterNodeGPU',
        'id': 'int',
        'name': 'str',
    ...
    def __init__(self, current_system_metrics=None, experiments_status_summary=None, gpu=None, id=None, name=None, services_status_summary=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def gpu(self):
        """Gets the gpu of this ResponseKernelClusterNodeInfo.  # noqa: E501


        :return: The gpu of this ResponseKernelClusterNodeInfo.  # noqa: E501
        :rtype: ResponseKernelClusterNodeGPU
        """
        return self._gpu

    @gpu.setter
    def gpu(self, gpu):
        """Sets the gpu of this ResponseKernelClusterNodeInfo.


        :param gpu: The gpu of this ResponseKernelClusterNodeInfo.  # noqa: E501
        :type gpu: ResponseKernelClusterNodeGPU
        """
