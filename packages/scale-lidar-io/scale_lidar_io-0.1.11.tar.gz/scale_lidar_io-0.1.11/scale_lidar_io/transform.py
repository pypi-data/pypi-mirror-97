...
class Transform:
    ...
    (Have in mind that not all the method from Transform will work using scaled/small matrixes)
    ...
    def from_euler(angles, axes='sxyz', degrees=False):
        """Create a transform based on euler angles
    ...
    def from_transformed_points(A, B):
        """Create a transform based on two points
