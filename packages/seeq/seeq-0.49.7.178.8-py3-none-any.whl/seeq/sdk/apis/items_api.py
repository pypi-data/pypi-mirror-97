...
class ItemsApi(object):
    ...
    def search_workbench(self, **kwargs):
        ...
        :param str filter: If set to 'public', only workbench items visible to the Everyone group are returned. If set to 'owner', only workbench items owned by the current user (or the userId specified) are returned. If set to 'shared' only workbench items where the current user (or the userId specified) has been given access are returned. If set to 'all' (or not specified), all workbench items the current user (or the userId specified) has access to will be returned.
    ...
    def search_workbench_with_http_info(self, **kwargs):
        ...
        all_params = ['types', 'folder_id', 'filter', 'is_archived', 'is_pinned', 'text_search', 'sort_order', 'limit', 'offset']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
