...
class DatasourceOutputV1(object):
    ...
    def __init__(self, additional_properties=None, cache_enabled=False, data_version_check=None, datasource_class=None, datasource_id=None, description=None, effective_permissions=None, href=None, id=None, is_archived=False, is_redacted=False, name=None, seeq_internal=False, status_message=None, stored_in_seeq=False, type=None):
        """
