...
def test_calculate_default_optimal_heap_sizes():
    # cores, physical, appserver, cassandra, jmvLink, postgres, netLink, renderer, reverse proxy, supervisor, os
    matrix_cols = [
        'Cpu/Count',
        'Memory/System/Total',
        'Memory/Appserver/Size',
        'Memory/Cassandra/Size',
        'Memory/JvmLink/Size',
    ...
    test_matrix = [
        ...
        [8, 4000, 1000, 500, 250, 2250, 250, 500, 250, 300, 250],
        [8, 8000, 2000, 1000, 500, 2250, 500, 1000, 500, 300, 500],
        [8, 12000, 3450, 1500, 750, 2250, 750, 1500, 750, 300, 750],
        [8, 16000, 4708, 2000, 1000, 2992, 1000, 2000, 1000, 300, 1000],
        [8, 32000, 9716, 4000, 2000, 5984, 2000, 4000, 2000, 300, 2000],
        [8, 64000, 23732, 8000, 4000, 11968, 4000, 4000, 4000, 300, 4000],
        [8, 128000, 59764, 8000, 8000, 23936, 8000, 4000, 8000, 300, 8000],
        [8, 256000, 131828, 8000, 16000, 47872, 16000, 4000, 16000, 300, 16000],
        # 64-bit, 64 cpu cores for screenshot purposes
        [64, 4000, 1000, 500, 250, 2250, 250, 500, 250, 300, 250],
        [64, 8000, 2000, 1000, 500, 2250, 500, 1000, 500, 300, 500],
        [64, 12000, 3450, 1500, 750, 2250, 750, 1500, 750, 300, 750],
        [64, 16000, 4708, 2000, 1000, 2992, 1000, 2000, 1000, 300, 1000],
        [64, 32000, 9716, 4000, 2000, 5984, 2000, 4000, 2000, 300, 2000],
        [64, 64000, 19732, 8000, 4000, 11968, 4000, 8000, 4000, 300, 4000],
        [64, 128000, 47764, 8000, 8000, 23936, 8000, 16000, 8000, 300, 8000],
        [64, 256000, 103828, 8000, 16000, 47872, 16000, 32000, 16000, 300, 16000],
        [64, 512000, 247956, 8000, 32000, 95744, 32000, 32000, 32000, 300, 32000]
    ]
