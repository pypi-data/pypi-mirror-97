...
class GenericCell(CellType):
    ...
    def __init__(self, voltage: float, capacity: float, soh: float, battery_config: BatteryConfig):
        ...
        self.__max_voltage = 4.01 * self._SERIAL_SCALE  # V
        self.__min_voltage = 2.99 * self._SERIAL_SCALE  # V
        ...
        # Dummy parameters for GenericCell
        self.__mass = 0.05  # kg
        ...
        self.__open_circuit_voltage_start = 3  # V
        self.__internal_resistance = 0.010  # Ohm


    def get_open_circuit_voltage(self, battery_state: LithiumIonState) -> float:
        return (self.__open_circuit_voltage_start + battery_state.soc) * self._SERIAL_SCALE
