...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of singlearity.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = singlearity.Configuration(
    ...
    Note you can use the constants defined in the singlearity.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = singlearity.Configuration(
        signing_info = singlearity.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("singlearity")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'SINGLEARITY_API_KEY' in self.api_key:
            auth['APIKeyHeader'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'SINGLEARITY_API_KEY',
                'value': self.get_api_key_with_prefix('SINGLEARITY_API_KEY')
            }
        if 'SINGLEARITY_API_KEY' in self.api_key:
            auth['APIKeyQuery'] = {
                'type': 'api_key',
