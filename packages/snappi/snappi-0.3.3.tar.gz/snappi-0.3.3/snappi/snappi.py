...
class CaptureFilterIter(SnappiIter):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureEthernet, CaptureIpv4, CaptureFilter, CaptureVlan, CaptureCustom]
        return self._getitem(key)
...
class FlowHeaderIter(SnappiIter):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowPpp, FlowIpv6, FlowGtpv1, FlowIpv4, FlowIcmp, FlowGtpv2, FlowVlan, FlowArp, FlowTcp, FlowIcmpv6, FlowGre, FlowUdp, FlowEthernetPause, FlowIgmpv1, FlowVxlan, FlowEthernet, FlowPfcPause, FlowCustom, FlowHeader]
        return self._getitem(key)
