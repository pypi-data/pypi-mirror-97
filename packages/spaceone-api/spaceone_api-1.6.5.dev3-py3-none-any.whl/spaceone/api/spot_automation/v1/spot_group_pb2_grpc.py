...
class SpotGroupStub(object):
    ...
    def __init__(self, channel):
        ...
        self.list = channel.unary_unary(
                ...
                request_serializer=spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.SpotGroupQuery.SerializeToString,
        ...
        self.interrupt = channel.unary_unary(
                '/spaceone.api.spot_automation.v1.SpotGroup/interrupt',
                request_serializer=spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.InterruptRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
        self.stat = channel.unary_unary(
                '/spaceone.api.spot_automation.v1.SpotGroup/stat',
                request_serializer=spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.SpotGroupStatQuery.SerializeToString,
...
def add_SpotGroupServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'list': grpc.unary_unary_rpc_method_handler(
                    servicer.list,
                    request_deserializer=spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.SpotGroupQuery.FromString,
            ...
            'interrupt': grpc.unary_unary_rpc_method_handler(
                    servicer.interrupt,
                    request_deserializer=spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.InterruptRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'stat': grpc.unary_unary_rpc_method_handler(
                    servicer.stat,
                    request_deserializer=spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.SpotGroupStatQuery.FromString,
...
class SpotGroup(object):
    ...
    def list(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.spot_automation.v1.SpotGroup/list',
            spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.SpotGroupQuery.SerializeToString,
    ...
    def interrupt(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.spot_automation.v1.SpotGroup/interrupt',
            spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.InterruptRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def stat(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.spot_automation.v1.SpotGroup/stat',
            spaceone_dot_api_dot_spot__automation_dot_v1_dot_spot__group__pb2.SpotGroupStatQuery.SerializeToString,
