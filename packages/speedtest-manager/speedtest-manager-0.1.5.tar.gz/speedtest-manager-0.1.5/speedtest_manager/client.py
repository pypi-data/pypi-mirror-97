...
def main() -> None:
    ...
    def no_op_error( _client: ManagerClient, _args ):

        print( "Please specify an operation." )
        exit( 1 )

    parser.set_defaults( family = socket.AF_UNIX, loglevel = DEFAULT_LOGLEVEL, func = no_op_error )

    subparsers = parser.add_subparsers( dest = 'operation', title = "Operations", description = "Operations that can be performed in the manager." )
