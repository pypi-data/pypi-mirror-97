...
from spsdk.dat import ShadowRegisters
from spsdk.dat.shadow_regs import enable_debug
from spsdk.debuggers.utils import DebugProbeUtils
from spsdk.exceptions import SPSDKError
from spsdk.utils.registers import RegConfig, RegsRegister
...
CONFIG_DIR = os.path.join(SPSDK_DATA_FOLDER, "shadow_regs")
...
def printregs(pass_obj: dict, rich: bool = False) -> None:
    ...
    try:
        ...
        for reg in shadow_regs.regs.registers:
