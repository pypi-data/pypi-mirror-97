...
Alternatively intall from github as follows:
...
The reference and test files described below can be obtained from [github](https://github.com/ekspla/Read-Symbian-SportsTracker-file).
