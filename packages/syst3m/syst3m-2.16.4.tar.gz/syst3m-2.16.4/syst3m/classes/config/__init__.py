...
# defaults.
import os,sys,json,pathlib,platform,time
...
# download.
	...
	import syst3m
	syst3m.defaults.install_requirements(f"{sys.executable} -m pip install -r {FilePath(__file__).base(back=3)}/requirements/requirements.pip")
