...
commands = {
    "ls": "      Retreive currency rates, optional: --asof <YYYY-MM-DD>",
    "list": "    Retreive currency rates",
    "info": "    Show currency pair exchange rate (via --pair|-p <CURR-PAIR>), optional: --asof <YYYY-MM-DD>"
}
