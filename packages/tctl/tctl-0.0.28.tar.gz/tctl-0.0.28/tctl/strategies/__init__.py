...
commands = {
    ...
    "set-public": "   Make a strategy public (via --strategy|-s <STRATEGY-ID>)",
    "set-private": "   Make a strategy private (via --strategy|-s <STRATEGY-ID>)",
    ...
    "report": "   Show strategy statistics (via --strategy|-s <STRATEGY-ID>)",
    "versions": "   Show strategy versions (via --strategy|-s <STRATEGY-ID>)",
    "version": "    Display strategy version (via --strategy|-s <STRATEGY-ID>, --version|-v <VERSION-ID>, optional: --decode)",
    "activate": "   Activate strategy version (via --strategy|-s <STRATEGY-ID>, --version|-v <VERSION-ID>)",
}

rules = utils.args_actions()
rules.add_required([
    "info", "update", "delete", "status", "log",
