...
class Client:
    ...
    def gs_to_bq(self, gs_uri, table, auto_detect=True, skip_leading_rows=True, separator=',',
                 write_preference='append', schema=(), partition_date=None):
        ...
        Args:
            ...
            partition_date (str): The ingestion date for partitioned BigQuery table. For example: ``20210101``. The partition field name will be __PARTITIONTIME
    ...
    def mysql_to_bq(self, instance_name, database, query, bq_table, bq_table_schema, write_preference='append', partition_date=None):
    ...
    def ftp_to_bq(self, ftp_connection_string, ftp_filepath, bq_table, separator=',',
                  skip_leading_rows=True, write_preference='append', partition_date=None):
    ...
    def salesforce_to_bq(self, salesforce_connection_string, salesforce_table, salesforce_columns, bq_table, bq_table_schema,
                         salesforce_condition=None, salesforce_include_deleted=False, write_preference='append', partition_date=None):
    ...
    def s3_to_bq(self, s3_connection_string, bucket_name, object_name,
                 ...
                 skip_leading_rows=True, write_preference='append', schema=[], partition_date=None):
        """
        ...
        bq_client.upload_table(os.path.join('/tmp/', object_name),
                               ...
                               write_preference, schema, partition_date)
