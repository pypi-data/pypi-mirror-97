...
class Client:
    ...
    def upload_table(self, file_path, table, separator=',', auto_detect=True, skip_leading_rows=True,
        ...
        Args:
            ...
            partition_date (str): The ingestion date for partitioned destination table. For example: ``20210101``. The partition field name will be __PARTITIONTIME
    ...
    def run_query(self, query=None, query_file_name=None, params=(), destination=None, partition_date=None):
