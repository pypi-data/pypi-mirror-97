...
MAX_FRAME_PIXEL = 38 * 100 + 27315
MIN_FRAME_PIXEL = 20 * 100 + 27315
...
CALIBRATION_MAP = {
    ...
    '0019002d-5113-3538-3930-383900000000': {'min': -7.16, 'max': -6.71},  # top right
    '8021002d-5110-3039-3433-373300000000': {'min': -4.66, 'max': -3.91},  # bottom left
    '80110004-5113-3538-3930-383900000000': {'min': -7.78, 'max': -6.71},  # bottom right
