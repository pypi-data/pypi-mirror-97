...
class Face_cropper:
    ...
    def generate_json_result(self,checks, is_inside, filename = "data.json"):
        ...
        data_set = {"up_left": {"difference_rate":checks[0][1],"score" : up_left_score},
                    ...
                    "up_right":{"difference_rate":checks[1][1],"score" : up_right_score},
                    ...
                    "bottom_left": {"difference_rate":checks[2][1],"score" : bottom_left_score},
                    #"bottom_center": {"difference_rate":checks[7][1],"score" : bottom_center_score},
                    "bottom_right": {"difference_rate":checks[3][1],"is_problem" : bottom_right_score}}
