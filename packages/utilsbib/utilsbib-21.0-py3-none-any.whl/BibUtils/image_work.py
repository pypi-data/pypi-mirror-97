...
class Face_cropper:
    ...
    def check_outside(self,fname):
        ...
        tiles_checks1= self.perform_outside_check(fname = fname,nb_t = nb_tt,m_type = m_type,m_color=m_color, color_diff = color_diff, pad = 40, show_plot=True,diff_black=60)
