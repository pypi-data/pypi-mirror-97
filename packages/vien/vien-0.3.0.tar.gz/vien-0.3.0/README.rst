...
.. image:: https://github.com/rtmigo/vien/workflows/CI/badge.svg?branch=master
...
**VIEN** is a command-line tool for managing `Python Virtual Environments <https://docs.python.org/3/library/venv.html>`_ in shell.
