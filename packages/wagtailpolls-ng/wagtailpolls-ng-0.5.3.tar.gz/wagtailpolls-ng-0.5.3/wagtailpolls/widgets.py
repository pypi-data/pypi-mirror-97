...
class AdminPollChooser(AdminChooser):
    ...
    def __init__(self, content_type=None, **kwargs):
        if "snippet_type_name" in kwargs:
            ...
            self.choose_one_text = _("Choose %(snippet_type_name)s") % {"snippet_type_name": snippet_type_name}
            self.choose_another_text = _("Choose another %(snippet_type_name)s") % {
                "snippet_type_name": snippet_type_name
            }
            self.link_to_chosen_text = _("Edit this %(snippet_type_name)s") % {"snippet_type_name": snippet_type_name}
