...
class ConsumerRocketMQ(ConsumerFactory):
    def __init__(self, consumer_group_id='', lookup_address='', node_address='', access_key='', access_secret='', thread_num=None, batch_size=None, **mq_options):
        self.consumer = PushConsumer(consumer_group_id)
